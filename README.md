...
* [Docker Curriculum](https://github.com/prakhar1989/docker-curriculum) ⭐ 6,036 | 🐛 94 | 🌐 SCSS | 📅 2026-02-04: A comprehensive tutorial for getting started with Docker. Teaches how to use Docker and deploy dockerized apps on AWS with Elastic Beanstalk and Elastic Container Service.
...
* [Dockerlings](https://github.com/furkan/dockerlings) ⭐ 879 | 🐛 0 | 🌐 Shell | 📅 2026-03-22: Learn docker from inside your terminal, with a modern TUI and bite sized exercises (by [furkan](https://github.com/furkan))

* [The Docker Handbook](https://docker-handbook.farhan.dev/) An open-source book that teaches you the fundamentals, best practices and some intermediate Docker functionalities. The book is hosted on [fhsinchy/the-docker-handbook](https://github.com/fhsinchy/the-docker-handbook) ⭐ 867 | 🐛 5 | 📅 2025-11-01 and the projects are hosted on [fhsinchy/docker-handbook-projects](https://github.com/fhsinchy/docker-handbook-projects) ⭐ 1,393 | 🐛 3 | 🌐 JavaScript | 📅 2025-02-07 repository.
...
* [Docker for beginners](https://github.com/groda/big_data/blob/master/docker_for_beginners.md) ⭐ 84 | 🐛 0 | 🌐 Jupyter Notebook | 📅 2026-03-16: A tutorial for beginners who need to learn the basics of Docker—from "Hello world!" to basic interactions with containers, with simple explanations of the underlying concepts.
...
* [wsargent](https://github.com/wsargent/docker-cheat-sheet) ⭐ 22,496 | 🐛 7 | 📅 2024-12-31 (Most popular)
* [eon01](https://github.com/eon01/DockerCheatSheet) ⭐ 3,927 | 🐛 1 | 📅 2026-02-19
...
* [Moby](https://github.com/moby/moby) ⭐ 71,553 | 🐛 3,800 | 🌐 Go | 📅 2026-03-31
* [Docker Compose](https://github.com/docker/compose/) ⭐ 37,209 | 🐛 80 | 🌐 Go | 📅 2026-03-31 (Define and run multi-container applications with Docker)
...
* [kompose](https://github.com/kubernetes/kompose) ⭐ 10,482 | 🐛 13 | 🌐 Go | 📅 2026-03-31 - Go from Docker Compose to Kubernetes.
* [podman-compose](https://github.com/containers/podman-compose) ⭐ 6,018 | 🐛 376 | 🌐 Python | 📅 2026-03-29 - A script to run docker-compose.yml using podman.
* [Composerize](https://github.com/magicmark/composerize) ⭐ 3,716 | 🐛 12 | 🌐 JavaScript | 📅 2026-01-17 - Convert docker run commands into docker-compose files.
* [LLM Harbor](https://github.com/av/harbor) ⭐ 2,551 | 🐛 60 | 🌐 TypeScript | 📅 2026-03-24 - A CLI and companion app to effortlessly run LLM backends, APIs, frontends, and services with one command. By [av](https://github.com/av).
* [habitus](https://github.com/cloud66-oss/habitus) ⭐ 1,392 | 🐛 8 | 🌐 Go | 📅 2020-02-05 :ice\_cube: - A Build Flow Tool for Docker.
...
* [werf](https://github.com/werf/werf) ⭐ 4,668 | 🐛 143 | 🌐 Go | 📅 2026-04-01 - Werf is a CI/CD tool for building Docker images efficiently and deploying them to Kubernetes using GitOps.
* [gitkube](https://github.com/hasura/gitkube) ⭐ 3,850 | 🐛 44 | 🌐 Go | 📅 2023-08-31 :ice\_cube: - Gitkube is a tool for building and deploying docker images on Kubernetes using `git push`. By [Hasura](https://github.com/hasura/).
...
* [awesome-stacks](https://github.com/ethibox/awesome-stacks) ⭐ 1,265 | 🐛 9 | 🌐 Dockerfile | 📅 2026-03-31 - Deploy 150+ open-source web apps with one Docker command.
...
* [Glances](https://github.com/nicolargo/glances) ⭐ 32,227 | 🐛 99 | 🌐 Python | 📅 2026-03-31 - A cross-platform curses-based system monitoring tool written in Python.

* [cAdvisor](https://github.com/google/cadvisor) ⭐ 19,023 | 🐛 92 | 🌐 Go | 📅 2026-03-19 - Analyzes resource usage and performance characteristics of running containers.

* [Checkmate](https://github.com/bluewave-labs/checkmate) ⭐ 9,475 | 🐛 99 | 🌐 TypeScript | 📅 2026-03-30 - Checkmate is an open-source, self-hosted tool designed to track and monitor server hardware, uptime, response times, and incidents in real-time with beautiful visualizations.

* [HertzBeat](https://github.com/dromara/hertzbeat) ⭐ 7,145 | 🐛 311 | 🌐 Java | 📅 2026-04-01 - An open-source real-time monitoring system with custom-monitor and agentless.

* [dockprom](https://github.com/stefanprodan/dockprom) ⭐ 6,499 | 🐛 20 | 📅 2026-03-06 - Docker hosts and containers monitoring with Prometheus, Grafana, cAdvisor, NodeExporter and AlertManager.

* [Logspout](https://github.com/gliderlabs/logspout) ⭐ 4,697 | 🐛 108 | 🌐 Go | 📅 2023-07-11 :ice\_cube: - Log routing for Docker container logs.

* [Autoheal](https://github.com/willfarrell/docker-autoheal) ⭐ 1,818 | 🐛 60 | 🌐 Shell | 📅 2025-09-09 - Monitor and restart unhealthy docker containers automatically.
...
* [Drydock](https://github.com/CodesWhat/drydock) ⭐ 171 | 🐛 15 | 🌐 TypeScript | 📅 2026-03-31 - Container update monitoring with web dashboard, 23 registry providers, 20 notification triggers, and distributed agent architecture. By [CodesWhat](https://github.com/CodesWhat).

* [Maintenant](https://github.com/kolapsis/maintenant) ⭐ 155 | 🐛 3 | 🌐 Go | 📅 2026-03-30 - Self-discovering infrastructure monitoring for Docker and Kubernetes. Auto-detects containers via labels, with endpoint monitoring, heartbeats, TLS certificates, resource metrics, update intelligence, and a built-in status page. Single binary with embedded SPA. By [kolapsis](https://github.com/kolapsis).
...
* [Docker-Sentinel](https://github.com/Will-Luck/Docker-Sentinel) ⭐ 15 | 🐛 0 | 🌐 Go | 📅 2026-03-13 - Automated container updates with per-container policies, rollback safety, and a real-time web dashboard. By [Will-Luck](https://github.com/Will-Luck).
...
* [DLIA](https://github.com/zorak1103/dlia) ⭐ 3 | 🐛 1 | 🌐 Go | 📅 2026-04-01 - DLIA is an AI-powered Docker log monitoring agent that uses Large Language Models (LLMs) to intelligently analyze container logs, detect anomalies, and provide contextual insights over time. By [zorak1103](https://github.com/zorak1103).

* [DockProbe](https://github.com/deep-on/dockprobe) ⭐ 3 | 🐛 1 | 🌐 Python | 📅 2026-03-31 - Lightweight Docker monitoring dashboard in a single container. Real-time metrics, 6 anomaly detection rules, Telegram alerts, and 16 automated security scans. Zero config, \~50MB RAM. By [DeepOn](https://github.com/deep-on).
...
* [netshoot](https://github.com/nicolaka/netshoot) ⭐ 10,527 | 🐛 43 | 🌐 Shell | 📅 2026-03-05 - The netshoot container has a powerful set of networking tools to help troubleshoot Docker networking issues.
* [MyIP](https://github.com/jason5ng32/MyIP) ⭐ 10,023 | 🐛 0 | 🌐 Vue | 📅 2026-03-30 - All in one IP Toolbox. Easy to check all your IPs, IP geolocation, check for DNS leaks, examine WebRTC connections, speed test, ping test, MTR test, check website availability, whois search and more. By [jason5ng32](https://github.com/jason5ng32).
* [Flannel](https://github.com/coreos/flannel/) ⭐ 9,426 | 🐛 25 | 🌐 Go | 📅 2026-03-31 - Flannel is a virtual network that gives a subnet to each host for use with container runtimes. By [coreos][coreos].
* [Pipework](https://github.com/jpetazzo/pipework) ⭐ 4,250 | 🐛 5 | 🌐 Shell | 📅 2024-11-04 - Software-Defined Networking for Linux Containers, Pipework works with "plain" LXC containers, and with the awesome Docker. By [jpetazzo][jpetazzo].
* [Freeflow](https://github.com/Microsoft/Freeflow) ⭐ 633 | 🐛 14 | 🌐 C | 📅 2023-06-12 :ice\_cube: - High performance container overlay networks on Linux. Enabling RDMA (on both InfiniBand and RoCE) and accelerating TCP to bare metal performance. By [Microsoft](https://github.com/Microsoft).
...
* [Kubernetes](https://github.com/kubernetes/kubernetes) ⭐ 121,419 | 🐛 2,673 | 🌐 Go | 📅 2026-04-01 - Open source orchestration system for Docker containers by Google.
* [Rancher](https://github.com/rancher/rancher) ⭐ 25,452 | 🐛 3,317 | 🌐 Go | 📅 2026-03-31 - An open source project that provides a complete platform for operating Docker in production.
* [Nomad](https://github.com/hashicorp/nomad) ⭐ 16,376 | 🐛 1,662 | 🌐 Go | 📅 2026-04-01 - Easily deploy applications at any scale. A Distributed, Highly Available, Datacenter-Aware Scheduler.
* [Mesos](https://github.com/apache/mesos) ⭐ 5,364 | 🐛 10 | 🌐 C++ | 📅 2024-08-23 - Resource/Job scheduler for containers, VM's and physical hosts [apache](https://mesos.apache.org/).
* [docker rollout](https://github.com/Wowu/docker-rollout) ⭐ 3,176 | 🐛 9 | 🌐 Shell | 📅 2026-03-11 - Zero downtime deployment for Docker Compose services.
* [ManageIQ](https://github.com/ManageIQ/manageiq) ⭐ 1,395 | 🐛 323 | 🌐 Ruby | 📅 2026-03-31 - Discover, optimize and control your hybrid IT. By [ManageIQ](https://github.com/ManageIQ).
* [Swarm-cronjob](https://github.com/crazy-max/swarm-cronjob) ⭐ 866 | 🐛 38 | 🌐 Go | 📅 2026-03-29 - Create jobs on a time-based schedule on Swarm by [crazy-max].
...
* [CloudSlang](https://github.com/CloudSlang/cloud-slang) ⭐ 240 | 🐛 110 | 🌐 Java | 📅 2026-03-18 - CloudSlang is a workflow engine to create Docker process automation.
...
* [Dokku](https://github.com/dokku/dokku) ⭐ 31,927 | 🐛 39 | 🌐 Shell | 📅 2026-03-30 - Docker powered mini-Heroku that helps you build and manage the lifecycle of applications (originally by [progrium][progrium]).
* [caprover](https://github.com/caprover/caprover) ⭐ 14,948 | 🐛 178 | 🌐 TypeScript | 📅 2026-01-31 - \[Previously known as CaptainDuckDuck] Automated Scalable Webserver Package (automated Docker+nginx) - Heroku on Steroids.
* [Tsuru](https://github.com/tsuru/tsuru) ⭐ 5,264 | 🐛 21 | 🌐 Go | 📅 2026-03-19 - Tsuru is an extensible and open source Platform as a Service software.
...
* [Convox Rack](https://github.com/convox/rack) ⭐ 1,890 | 🐛 30 | 🌐 Go | 📅 2026-03-31 - Convox Rack is open source PaaS built on top of expert infrastructure automation and devops best practices.
...
* [Exoframe](https://github.com/exoframejs/exoframe) ⭐ 1,147 | 🐛 16 | 🌐 JavaScript | 📅 2026-02-22 - A self-hosted tool that allows simple one-command deployments using Docker.
...
* [Træfɪk](https://github.com/containous/traefik) ⭐ 62,421 | 🐛 772 | 🌐 Go | 📅 2026-03-31 - Automated reverse proxy and load-balancer for Docker, Mesos, Consul, Etcd... By [EmileVauge](https://github.com/emilevauge).
* [Nginx Proxy Manager](https://github.com/jc21/nginx-proxy-manager) ⭐ 32,322 | 🐛 951 | 🌐 TypeScript | 📅 2026-03-29 - A beautiful web interface for proxying web based services with SSL. By [jc21](https://github.com/jc21).
* [BunkerWeb](https://github.com/bunkerity/bunkerweb) ⭐ 10,223 | 🐛 182 | 🌐 Python | 📅 2026-03-31 - Open-source and next-gen Web Application Firewall (WAF). By [Bunkerity](https://www.bunkerity.com).
* [Let's Encrypt Nginx-proxy Companion](https://github.com/nginx-proxy/docker-letsencrypt-nginx-proxy-companion) ⭐ 7,701 | 🐛 50 | 🌐 Shell | 📅 2026-03-16 - A lightweight companion container for the nginx-proxy. It allow the creation/renewal of Let's Encrypt certificates automatically. By [JrCs](https://github.com/JrCs).
* [fabio](https://github.com/fabiolb/fabio) ⭐ 7,335 | 🐛 239 | 🌐 Go | 📅 2026-03-26 - A fast, modern, zero-conf load balancing HTTP(S) router for deploying microservices managed by consul. By [magiconair](https://github.com/magiconair) (Frank Schroeder).
* [caddy-docker-proxy](https://github.com/lucaslorentz/caddy-docker-proxy) ⭐ 4,367 | 🐛 48 | 🌐 Go | 📅 2026-03-31 - Caddy-based reverse proxy, configured with service or container labels. By [lucaslorentz](https://github.com/lucaslorentz).
* [OpenResty Manager](https://github.com/Safe3/openresty-manager) ⭐ 1,341 | 🐛 54 | 🌐 Go | 📅 2026-01-25 - The easiest using, powerful and beautiful OpenResty Manager(Nginx Enhanced Version), open source alternative to OpenResty Edge. By [Safe3](https://github.com/Safe3/).
...
* [mesh-router](https://github.com/Yundera/mesh-router) ⭐ 10 | 🐛 0 | 🌐 TypeScript | 📅 2026-03-02 - Free domain(nsl.sh) provider for Docker containers with automatic HTTPS routing. Uses Wireguard VPN to securely route subdomain requests across networks. Ideal for self-hosted NAS and cloud deployments. By [Yundera](https://github.com/Yundera).
* [nginx-proxy][nginxproxy] - Automated nginx proxy for Docker containers using docker-gen by [jwilder][jwilder]

### Runtime

* [podman](https://github.com/containers/libpod) ⭐ 31,187 | 🐛 1,080 | 🌐 Go | 📅 2026-04-01 - Libpod is a library used to create container pods. Home of Podman.
* [cri-o](https://github.com/cri-o/cri-o) ⭐ 5,596 | 🐛 89 | 🌐 Go | 📅 2026-04-01 - Open Container Initiative-based implementation of Kubernetes Container Runtime Interface by [cri-o](https://github.com/cri-o).
* [lxc](https://github.com/lxc/lxc) ⭐ 5,150 | 🐛 171 | 🌐 C | 📅 2026-03-23 - LXC - Linux Containers.
* [runtime-tools](https://github.com/opencontainers/runtime-tools) ⭐ 475 | 🐛 70 | 🌐 Go | 📅 2026-03-16 - Oci-runtime-tool is a collection of tools for working with the OCI runtime specification.
* [Mocker](https://github.com/us/mocker) ⭐ 91 | 🐛 0 | 🌐 Swift | 📅 2026-03-28 - Docker-compatible container CLI for macOS, built on Apple's Containerization framework. By [us](https://github.com/us).
* [rlxc](https://github.com/brauner/rlxc) ⭐ 18 | 🐛 0 | 🌐 Rust | 📅 2021-06-30 :ice\_cube: - LXC binary written in Rust.

### Security

* [Trivy](https://github.com/aquasecurity/trivy) ⭐ 34,264 | 🐛 242 | 🌐 Go | 📅 2026-03-30 - Aqua Security's open source simple and comprehensive vulnerability scanner for containers (suitable for CI).
* [Grype](https://github.com/anchore/grype) ⭐ 11,910 | 🐛 387 | 🌐 Go | 📅 2026-03-31 - A vulnerability scanner for container images, filesystems and SBOMs. By [Anchore](https://github.com/anchore).
* [Clair](https://github.com/quay/clair) ⭐ 10,959 | 🐛 48 | 🌐 Go | 📅 2026-03-31 - Clair is an open source project for the static analysis of vulnerabilities in appc and docker containers. By [coreos][coreos].
* [docker-bench-security](https://github.com/docker/docker-bench-security) ⭐ 9,607 | 🐛 26 | 🌐 Shell | 📅 2024-10-21 - Script that checks for dozens of common best-practices around deploying Docker containers in production. By [docker][docker].
* [Sysdig Falco](https://github.com/falcosecurity/falco) ⭐ 8,809 | 🐛 58 | 🌐 C++ | 📅 2026-03-30 - Sysdig Falco is an open source container security monitor. It can monitor application, container, host, and network activity and alert on unauthorized activity.
* [Syft](https://github.com/anchore/syft) ⭐ 8,622 | 🐛 560 | 🌐 Go | 📅 2026-03-31 - CLI tool and library for generating a Software Bill of Materials (SBOM) from container images and filesystems. By [Anchore](https://github.com/anchore).
* [Checkov](https://github.com/bridgecrewio/checkov) ⭐ 8,575 | 🐛 155 | 🌐 Python | 📅 2026-03-30 - Static analysis for infrastructure as code manifests (Terraform, Kubernetes, Cloudformation, Helm, Dockerfile, Kustomize) find security misconfiguration and fix them. By [bridgecrew](https://github.com/bridgecrewio).
* [Deepfence Threat Mapper](https://github.com/deepfence/ThreatMapper) ⭐ 5,248 | 🐛 142 | 🌐 TypeScript | 📅 2026-03-08 - Powerful runtime vulnerability scanner for kubernetes, virtual machines and serverless. By [deepfence][deepfence].
* [KICS](https://github.com/checkmarx/kics) ⭐ 2,607 | 🐛 292 | 🌐 Open Policy Agent | 📅 2026-03-31 - An infrastructure-as-code scanning tool, find security vulnerabilities, compliance issues, and infrastructure misconfigurations early in the development cycle. Can be extended for additional policies. By [Checkmarx](https://github.com/Checkmarx).
* [oscap-docker](https://github.com/OpenSCAP/openscap) ⭐ 1,687 | 🐛 59 | 🌐 XSLT | 📅 2026-03-31 - OpenSCAP provides oscap-docker tool which is used to scan Docker containers and images. By [OpenSCAP](https://github.com/OpenSCAP).
* [Dagda](https://github.com/eliasgranderubio/dagda) ⭐ 1,226 | 🐛 25 | 🌐 Python | 📅 2023-05-23 :ice\_cube: - Dagda is a tool to perform static analysis of known vulnerabilities, trojans, viruses, malware & other malicious threats in docker images/containers and to monitor the docker daemon and running docker containers for detecting anomalous activities. By [eliasgranderubio](https://github.com/eliasgranderubio).
...
* [crowdsec-blocklist-import](https://github.com/wolffcatskyy/crowdsec-blocklist-import) ⭐ 189 | 🐛 2 | 🌐 Python | 📅 2026-03-25 - Aggregates 36 free threat intelligence feeds into 120k+ malicious IPs for CrowdSec bouncers, providing 10-20x more blocks than default lists. By [wolffcatskyy](https://github.com/wolffcatskyy).
* [CetusGuard](https://github.com/hectorm/cetusguard) ⭐ 83 | 🐛 2 | 🌐 Go | 📅 2026-03-01 - CetusGuard is a tool that protects the Docker daemon socket by filtering calls to its API endpoints.
...
* [buildcage](https://github.com/dash14/buildcage) ⭐ 4 | 🐛 0 | 🌐 JavaScript | 📅 2026-03-17 - Restricts outbound network access during Docker builds to prevent supply chain attacks, working as a drop-in BuildKit remote driver for Docker Buildx, with ready-to-use GitHub Actions.
...
* [etcd](https://github.com/etcd-io/etcd) ⭐ 51,672 | 🐛 211 | 🌐 Go | 📅 2026-03-31 - Distributed reliable key-value store for the most critical data of a distributed system by [etcd-io](https://github.com/etcd-io) (former part of CoreOS).
* [istio](https://github.com/istio/istio) ⭐ 38,070 | 🐛 522 | 🌐 Go | 📅 2026-04-01 - An open platform to connect, manage, and secure microservices.
...
* [Docker Volume Backup](https://github.com/offen/docker-volume-backup) ⭐ 3,474 | 🐛 28 | 🌐 Go | 📅 2026-03-31 Backup Docker volumes locally or to any S3 compatible storage. By [offen](https://github.com/offen)

* [REX-Ray](https://github.com/rexray/rexray) ⭐ 2,219 | 🐛 294 | 🌐 Go | 📅 2023-09-02 provides a vendor agnostic storage orchestration engine. The primary design goal is to provide persistent storage for Docker, Kubernetes, and Mesos. By[thecodeteam](https://github.com/thecodeteam) (DELL Technologies)
...
* [duplicacy-cli-cron](https://github.com/GeiserX/duplicacy-cli-cron) ⭐ 1 | 🐛 0 | 🌐 Shell | 📅 2026-03-31 - Docker-based encrypted dual-storage backup automation using Duplicacy CLI with cross-site redundancy and Telegram notifications. By [GeiserX](https://github.com/GeiserX).
...
* [docker.el](https://github.com/Silex/docker.el) ⭐ 813 | 🐛 6 | 🌐 Emacs Lisp | 📅 2026-01-26 Manage docker from Emacs by [Silex](https://github.com/Silex)
...
* [Stevedore](https://github.com/slonopotamus/stevedore) ⭐ 369 | 🐛 3 | 🌐 Rust | 📅 2026-03-26 - Good Docker Desktop replacement for Windows. Both Linux and Windows Containers are supported. [slonopotamus](https://github.com/slonopotamus).
...
* [dive](https://github.com/wagoodman/dive) ⭐ 53,675 | 🐛 201 | 🌐 Go | 📅 2025-12-15 - A tool for exploring each layer in a docker image. By [wagoodman](https://github.com/wagoodman).
* [lazydocker](https://github.com/jesseduffield/lazydocker) ⭐ 50,469 | 🐛 266 | 🌐 Go | 📅 2026-03-15 - The lazier way to manage everything docker. A simple terminal UI for both docker and docker-compose, written in Go with the gocui library. By [jesseduffield](https://github.com/jesseduffield).
* [dockly](https://github.com/lirantal/dockly) ⭐ 4,017 | 🐛 3 | 🌐 JavaScript | 📅 2026-02-01 - An interactive shell UI for managing Docker containers.
* [dry](https://github.com/moncho/dry) ⭐ 3,238 | 🐛 25 | 🌐 Go | 📅 2026-03-30 - An interactive CLI for Docker containers.
* [DockSTARTer](https://github.com/GhostWriters/DockSTARTer) ⭐ 2,549 | 🐛 7 | 🌐 Shell | 📅 2026-03-30 - DockSTARTer helps you get started with home server apps running in Docker by [GhostWriters](https://github.com/GhostWriters).
* [oxker](https://github.com/mrjackwills/oxker) ⭐ 1,586 | 🐛 20 | 🌐 Rust | 📅 2026-03-24 - A simple tui to view & control docker containers. Written in [Rust](https://rust-lang.org/), making heavy use of [ratatui](https://github.com/tui-rs-revival/ratatui) ⭐ 19,453 | 🐛 194 | 🌐 Rust | 📅 2026-03-31 & [Bollard](https://github.com/fussybeaver/bollard) ⭐ 1,244 | 🐛 45 | 🌐 Rust | 📅 2026-03-28,.
* [lazyjournal](https://github.com/Lifailon/lazyjournal) ⭐ 1,210 | 🐛 1 | 🌐 Go | 📅 2026-03-16 - A interface for reading and filtering the logs output of Docker and Podman containers like [Dozzle](origin/dozzle) but for the terminal with support for fuzzy find, regex and output coloring.
...
* [DockMate](https://github.com/shubh-io/dockmate) ⭐ 289 | 🐛 1 | 🌐 Go | 📅 2026-03-20 - Lightweight terminal-based Docker and Podman manager with a text-based user interface,.
* [dockdash](https://github.com/byrnedo/dockdash) ⭐ 124 | 🐛 0 | 🌐 Go | 📅 2022-06-01 detailed stats. By [byrnedo]
* [tdocker](https://github.com/pivovarit/tdocker) ⭐ 80 | 🐛 1 | 🌐 Go | 📅 2026-03-29 - A `docker ps` replacement for everyday container operations by [@pivovarit](https://github.com/pivovarit).
* [d4s](https://github.com/jr-k/d4s) ⭐ 65 | 🐛 0 | 🌐 Go | 📅 2026-03-16 - A fast, keyboard-driven terminal UI to manage Docker containers, Compose stacks, and Swarm services with the ergonomics of K9s.
* [dprs](https://github.com/durableprogramming/dprs) ⭐ 36 | 🐛 0 | 🌐 Rust | 📅 2026-03-05 - A developer-focused TUI for managing Docker containers with real-time log streaming and container management. Built with Rust. By [durableprogramming](https://github.com/durableprogramming).
* [swarmcli](https://github.com/Eldara-Tech/swarmcli) ⭐ 11 | 🐛 11 | 🌐 Go | 📅 2026-03-31 - Swarm Management at the speed of thought — with real-time log streaming, instant shell access to containers, seamless port forwarding, and on-demand secret reveal capabilities, giving you full control over your Docker Swarm without breaking your flow.

##### CLI tools

* [skopeo](https://github.com/containers/skopeo) ⭐ 10,638 | 🐛 69 | 🌐 Go | 📅 2026-03-30 - Work with remote images registries - retrieving information, images, signing content.
...
* [decompose](https://github.com/s0rg/decompose) ⭐ 128 | 🐛 4 | 🌐 Go | 📅 2026-03-20 - Reverse-engineering tool for docker environments. By [s0rg](https://github.com/s0rg).
...
* [supdock](https://github.com/segersniels/supdock) ⭐ 85 | 🐛 0 | 🌐 Rust | 📅 2026-02-23 - Allows for slightly more visual usage of Docker with an interactive prompt. By [segersniels](https://github.com/segersniels).
...
* [docker-captain](https://github.com/lucabello/docker-captain) ⭐ 2 | 🐛 2 | 🌐 Python | 📅 2026-03-30 - A friendly CLI to manage multiple Docker Compose deployments with style — powered by Typer, Rich, questionary, and sh.
...
* [dockerfile-mode](https://github.com/spotify/dockerfile-mode) ⭐ 561 | 🐛 12 | 🌐 Emacs Lisp | 📅 2025-12-21 An emacs mode for handling Dockerfiles by [spotify][spotify]
...
* [netdata](https://github.com/netdata/netdata) ⭐ 78,273 | 🐛 267 | 🌐 C | 📅 2026-04-01 - Real-time performance monitoring.
* [Portainer](https://github.com/portainer/portainer) ⭐ 37,017 | 🐛 732 | 🌐 TypeScript | 📅 2026-03-31 - A lightweight management UI for managing your Docker hosts or Docker Swarm clusters.
* [dockge](https://github.com/louislam/dockge) ⭐ 22,663 | 🐛 143 | 🌐 TypeScript | 📅 2026-01-21 - Easy-to-use and reactive self-hosted docker compose.yaml stack-oriented manager.
* [Theia](https://github.com/eclipse-theia/theia) ⭐ 21,431 | 🐛 1,467 | 🌐 TypeScript | 📅 2026-03-31 - Extensible platform to develop full-fledged multi-language Cloud & Desktop IDE-like products with state-of-the-art web technologies.
* [Komodo](https://github.com/mbecker20/komodo) ⭐ 10,781 | 🐛 443 | 🌐 Rust | 📅 2026-03-31 - A tool to build and deploy software on many servers.
...
* [Arcane](https://github.com/getarcaneapp/arcane) ⭐ 5,139 | 🐛 109 | 🌐 Go | 📅 2026-04-01 - An easy and modern Docker management platform, built with everybody in mind. By [getarcaneapp](https://github.com/getarcaneapp).
* [Swarmpit](https://github.com/swarmpit/swarmpit) ⭐ 3,418 | 🐛 194 | 🌐 Clojure | 📅 2026-03-04 - Swarmpit provides simple and easy to use interface for your Docker Swarm cluster. You can manage your stacks, services, secrets, volumes, networks etc.
...
* [Seagull](https://github.com/tobegit3hub/seagull) ⭐ 1,937 | 🐛 20 | 🌐 JavaScript | 📅 2017-11-22 :ice\_cube: - Friendly Web UI to monitor docker daemon.
...
* [dockemon](https://github.com/ProductiveOps/dokemon) ⭐ 761 | 🐛 18 | 🌐 TypeScript | 📅 2024-02-21 :ice\_cube: - Docker Container Management GUI.
* [Mafl](https://github.com/hywax/mafl) ⭐ 682 | 🐛 45 | 🌐 TypeScript | 📅 2025-10-26 - Minimalistic flexible homepage.
* [Docker Registry Browser](https://github.com/klausmeyer/docker-registry-browser) ⭐ 678 | 🐛 9 | 🌐 Ruby | 📅 2026-03-29 - Web Interface for the Docker Registry HTTP API v2.
* [Swirl](https://github.com/cuigh/swirl) ⭐ 669 | 🐛 23 | 🌐 Go | 📅 2023-05-16 :ice\_cube: - Swirl is a web management tool for Docker, focused on swarm cluster By [cuigh](https://github.com/cuigh/).
* [docker-registry-web](https://github.com/mkuchin/docker-registry-web) ⭐ 548 | 🐛 47 | 🌐 Groovy | 📅 2022-02-08 :ice\_cube: - Web UI, authentication service and event recorder for private docker registry v2.
* [Container Web TTY](https://github.com/wrfly/container-web-tty) ⭐ 258 | 🐛 10 | 🌐 Go | 📅 2026-03-29 - Connect your containers via a web-tty [wrfly](https://github.com/wrfly).
...
* [CASA](https://github.com/knrdl/casa) ⭐ 85 | 🐛 0 | 🌐 Svelte | 📅 2026-03-30 - Outsource the administration of a handful of containers to your co-workers,.
* [usulnet](https://github.com/fr4nsys/usulnet) ⭐ 84 | 🐛 2 | 🌐 Go | 📅 2026-02-23 - A complete and modern Docker management platform designed for sysadmin, devops with enterprise grade tools, cve scanner, ssh, rdp on web and much more. By [fr4nsys](https://github.com/fr4nsys).
...
* [distroless](https://github.com/GoogleContainerTools/distroless) ⭐ 22,458 | 🐛 16 | 🌐 Starlark | 📅 2026-03-27 - Language focused docker images, minus the operating system,.

* [docker-alpine](https://github.com/gliderlabs/docker-alpine) ⭐ 5,714 | 🐛 123 | 🌐 Shell | 📅 2021-04-01 :ice\_cube: - A super small Docker base image *(5MB)* using Alpine Linux.

* [GoSu](https://github.com/tianon/gosu) ⭐ 4,951 | 🐛 8 | 🌐 Shell | 📅 2026-03-04 - Run this specific application as this specific user and get out of the pipeline (entrypoint script tool).

* [docker-gen](https://github.com/jwilder/docker-gen) ⭐ 4,622 | 🐛 53 | 🌐 Go | 📅 2026-03-31 - Generate files from docker container meta-data.

* [Ofelia](https://github.com/mcuadros/ofelia/) ⭐ 3,781 | 🐛 145 | 🌐 Go | 📅 2026-04-01 - Ofelia is a modern and low footprint job scheduler for docker environments, built on Go. Ofelia aims to be a replacement for the old fashioned cron. Supports configuration from container labels and/or configuration files.

* [supercronic](https://github.com/aptible/supercronic) ⭐ 2,440 | 🐛 45 | 🌐 Go | 📅 2026-03-12 - Crontab-compatible job runner, designed specifically to run in containers.
...
* [microcheck](https://github.com/tarampampam/microcheck) ⭐ 136 | 🐛 2 | 🌐 C | 📅 2026-04-01 - Lightweight health check utilities for Docker containers (75 KB instead of 9.3 MB for httpcheck versus cURL) in pure C - http(s), port checks, and parallel execution are included.
...
* [DockerSlim](https://github.com/docker-slim/docker-slim) ⭐ 23,114 | 🐛 206 | 🌐 Go | 📅 2026-03-29 shrinks fat Docker images creating the smallest possible images.

* [BuildKit](https://github.com/moby/buildkit) ⭐ 9,868 | 🐛 945 | 🌐 Go | 📅 2026-03-31 - Concurrent, cache-efficient, and Dockerfile-agnostic builder toolkit.

* [buildah](https://github.com/containers/buildah) ⭐ 8,701 | 🐛 242 | 🌐 Go | 📅 2026-03-31 - A tool that facilitates building OCI images.
...
* [runlike](https://github.com/lavie/runlike) ⭐ 2,922 | 🐛 7 | 🌐 Python | 📅 2025-12-04 - Generate `docker run`command and options from running containers.
...
* [Derrick](https://github.com/alibaba/derrick) ⭐ 692 | 🐛 11 | 🌐 Go | 📅 2023-03-06 :ice\_cube: - A tool help you to automate the generation of Dockerfile and dockerize application by scanning the code. By [alibaba](https://github.com/alibaba).

* [RAUDI](https://github.com/cybersecsi/RAUDI) ⭐ 561 | 🐛 5 | 🌐 Python | 📅 2026-03-31 - A tool to automatically update (and optionally push to Docker Hub) Docker Images for 3rd party software whenever theres is a new release/update/commit. By [SecSI](https://github.com/cybersecsi).
...
* [dlayer](https://github.com/orisano/dlayer) ⭐ 446 | 🐛 6 | 🌐 Go | 📅 2026-03-28 - Docker layer analyzer.
...
* [dockerfilegraph](https://github.com/patrickhoefler/dockerfilegraph) ⭐ 261 | 🐛 0 | 🌐 Go | 📅 2026-03-31 - Visualize your multi-stage Dockerfiles. By [PatrickHoefler](https://github.com/patrickhoefler).
...
* [Dockershelf](https://github.com/Dockershelf/dockershelf) ⭐ 96 | 🐛 0 | 🌐 Shell | 📅 2026-03-12 - A repository that serves as a collector for docker recipes that are universal, efficient and slim. Images are updated, tested and published daily via a Travis cron job.
...
* [Hadolint](https://github.com/hadolint/hadolint) ⭐ 12,027 | 🐛 258 | 🌐 Haskell | 📅 2026-03-09 - A Dockerfile linter that checks for best practices, common mistakes, and is also able to lint any bash written in `RUN` instructions;.
* [FROM:latest](https://github.com/replicatedhq/dockerfilelint) ⭐ 1,032 | 🐛 55 | 🌐 JavaScript | 📅 2023-09-27 :ice\_cube: - An opinionated Dockerfile linter.
...
* [docker-image-size-limit](https://github.com/wemake-services/docker-image-size-limit) ⭐ 130 | 🐛 2 | 🌐 Python | 📅 2026-04-01 - A tool to keep an eye on your docker images size.
...
* [opencontainer](https://github.com/opencontainers/image-spec/blob/main/annotations.md) ⭐ 4,204 | 🐛 75 | 🌐 Go | 📅 2026-02-26 - A convention and shared namespace for Docker labels defined by OCI Image Spec.

### Registry

Services to securely store your Docker images.

* [Harbor](https://github.com/goharbor/harbor) ⭐ 27,864 | 🐛 827 | 🌐 Go | 📅 2026-03-30 An open source trusted cloud native registry project that stores, signs, and scans content. Supports replication, user management, access control and activity auditing. By [CNCF](https://www.cncf.io) formerly [VMWare][vmware]
* [Kraken](https://github.com/uber/kraken) ⭐ 6,670 | 🐛 119 | 🌐 Go | 📅 2026-03-30 - Uber's Highly scalable P2P docker registry, capable of distributing TBs of data in seconds.
* [Dragonfly](https://github.com/dragonflyoss/Dragonfly2) ⭐ 3,111 | 🐛 27 | 🌐 Go | 📅 2026-03-31 - Provide efficient, stable and secure file distribution and image acceleration based on p2p technology.
...
* [NORA](https://github.com/getnora-io/nora) ⭐ 35 | 🐛 10 | 🌐 Rust | 📅 2026-03-31 - Lightweight multi-protocol artifact registry supporting Docker, Maven, npm, Cargo and PyPI in a single 32MB binary. Pull-through cache, Web UI, Prometheus metrics, RBAC auth.
...
* [dockerode](https://github.com/apocas/dockerode) ⭐ 4,858 | 🐛 23 | 🌐 JavaScript | 📅 2026-03-26 - Docker Remote API node.js module.
...
* [go-dockerclient](https://github.com/fsouza/go-dockerclient/) ⭐ 2,232 | 🐛 13 | 🌐 Go | 📅 2026-03-31 - Go HTTP client for the Docker remote API.
* [docker-maven-plugin](https://github.com/fabric8io/docker-maven-plugin) ⭐ 1,927 | 🐛 517 | 🌐 Java | 📅 2026-03-25 - A Maven plugin for running and creating Docker images.
...
* [docker-java-api](https://github.com/amihaiemil/docker-java-api) ⭐ 274 | 🐛 25 | 🌐 Java | 📅 2021-06-04 :ice\_cube: - Lightweight, truly object-oriented, Java client for Docker's API. By [amihaiemil](https://github.com/amihaiemil).
...
* [Docker Client for JVM](https://github.com/gesellix/docker-client) ⭐ 119 | 🐛 29 | 🌐 Groovy | 📅 2026-03-27 - A Docker remote api client library for the JVM, written in Groovy.
* [Gradle Docker plugin](https://github.com/gesellix/gradle-docker-plugin) ⭐ 81 | 🐛 20 | 🌐 Java | 📅 2026-03-30 - A Docker remote api plugin for Gradle.
...
* [Drone](https://github.com/drone/drone) ⭐ 34,272 | 🐛 85 | 🌐 Go | 📅 2026-03-31 - Continuous integration server built on Docker and configured using YAML files.
* [Diun](https://github.com/crazy-max/diun) ⭐ 4,541 | 🐛 104 | 🌐 Go | 📅 2026-03-30 - Receive notifications when an image or repository is updated on a Docker registry by [crazy-max].
* [dockcheck](https://github.com/mag37/dockcheck) ⭐ 2,264 | 🐛 11 | 🌐 Shell | 📅 2026-03-30 - A script checking updates for docker images without pulling then auto-update selected/all containers. With notifications, pruning and more.
...
* [Docker plugin for Jenkins](https://github.com/jenkinsci/docker-plugin/) ⭐ 499 | 🐛 72 | 🌐 Java | 📅 2026-02-28 - The aim of the docker plugin is to be able to use a docker host to dynamically provision a slave, run a single build, then tear-down that slave.
...
* [Defang](https://github.com/DefangLabs/defang) ⭐ 150 | 🐛 197 | 🌐 Go | 📅 2026-03-31 - Deploy Docker Compose to your favorite cloud in minutes.
...
* [Gantry](https://github.com/shizunge/gantry) ⭐ 87 | 🐛 3 | 🌐 Shell | 📅 2026-03-31 - Automatically update selected Docker swarm services.
...
* [coder](https://github.com/coder/coder) ⭐ 12,748 | 🐛 914 | 🌐 Go | 📅 2026-04-01 - Remote development machines powered by Terraform or Docker.
* [Eclipse Che](https://github.com/eclipse/che) ⭐ 7,143 | 🐛 271 | 🌐 TypeScript | 📅 2026-03-30 - Developer workspace server with Docker runtimes, cloud IDE, next-generation Eclipse IDE.
* [Lando](https://github.com/lando/lando) ⭐ 4,225 | 🐛 179 | 📅 2026-02-24 - Lando is for developers who want to quickly specify and painlessly spin up the services and tools needed to develop their projects. By [Tandem](https://www.thinktandem.io/).
...
* [Zsh-in-Docker](https://github.com/deluan/zsh-in-docker) ⭐ 1,100 | 🐛 9 | 🌐 Shell | 📅 2024-09-30 - Install Zsh, Oh-My-Zsh and plugins inside a Docker container with one line! By [Deluan](https://www.deluan.com).
...
* [Gebug](https://github.com/moshebe/gebug) ⭐ 634 | 🐛 22 | 🌐 Go | 📅 2026-03-26 - A tool that makes debugging of Dockerized Go applications super easy by enabling Debugger and Hot-Reload features, seamlessly.
...
* [ESP32 Linux - Docker builder](https://github.com/hpsaturn/esp32s3-linux) ⭐ 78 | 🐛 0 | 🌐 Dockerfile | 📅 2025-04-05 - Container solution to compile Linux and develop it for ESP32 microcontrollers - By [Hpsaturn](https://github.com/hpsaturn).
...
* [Docuum](https://github.com/stepchowfun/docuum) ⭐ 688 | 🐛 14 | 🌐 Rust | 📅 2026-03-31 - Least recently used (LRU) eviction of Docker images.
...
* [docker\_gc](https://github.com/pdacity/docker_gc) ⭐ 129 | 🐛 0 | 🌐 Shell | 📅 2024-02-09 :ice\_cube: - Image for automatic removing unused Docker Swarm objects. Also works just as Docker Service.
...
* [OpenFaaS](https://github.com/openfaas/faas) ⭐ 26,122 | 🐛 31 | 🌐 Go | 📅 2026-03-09 - A complete serverless functions framework for Docker and Kubernetes. By [OpenFaaS](https://github.com/openfaas).

* [Apache OpenWhisk](https://github.com/apache/openwhisk) ⭐ 6,765 | 🐛 434 | 🌐 Scala | 📅 2026-03-24 - A serverless, open source cloud platform that executes functions in response to events at any scale. By [apache](https://github.com/apache).
...
* [dgoss](https://github.com/goss-org/goss/tree/master/extras/dgoss) ⭐ 5,874 | 🐛 94 | 🌐 Go | 📅 2025-05-01 - A fast YAML based tool for validating docker containers.
* [Pumba](https://github.com/alexei-led/pumba) ⭐ 3,003 | 🐛 10 | 🌐 Go | 📅 2026-03-19 - Chaos testing tool for Docker. Can be deployed on kubernetes and CoreOS cluster. By [alexei-led](https://github.com/alexei-led).
* [Container Structure Test](https://github.com/GoogleContainerTools/container-structure-test) ⭐ 2,465 | 🐛 113 | 🌐 Go | 📅 2026-03-16 - A framework to validate the structure of an image by checking the outputs of commands or the contents of the filesystem. By [GoogleContainerTools][googlecontainertools].
* [Kurtosis](https://github.com/kurtosis-tech/kurtosis) ⭐ 529 | 🐛 283 | 🌐 Go | 📅 2026-03-31 - A composable build system for multi-container test environments that provides developers with: a powerful Python-like SDK for environment configuration, a compile-time validator to verify environment behavior & setup, and a runtime for environment execution, monitoring, & debugging capabilities. By [Kurtosis](https://www.kurtosis.com/).
...
* [Preevy](https://github.com/livecycle/preevy) ⭐ 2,195 | 🐛 50 | 🌐 TypeScript | 📅 2026-02-06 - Preview environments for Docker and Docker Compose projects. Test your changes and get feedback from devs and non-devs (Product/Design) by deploying pull requests to the your cloud provider as part of your CI pipeline.
...
* [udocker](https://github.com/indigo-dc/udocker) ⭐ 1,723 | 🐛 38 | 🌐 Python | 📅 2025-08-13 - A tool to execute simple docker containers in batch or interactive systems without root privileges.
...
* [Cloud Native Landscape](https://github.com/cncf/landscape) ⭐ 9,854 | 🐛 41 | 📅 2026-03-31
...
* [Awesome Selfhosted](https://github.com/awesome-selfhosted/awesome-selfhosted) ⭐ 283,228 | 🐛 0 | 📅 2026-03-30 list of Free Software network services and web applications which can be hosted locally by running in a classical way (setup local web server and run applications from there) or in a Docker container. By [Kickball](https://github.com/Kickball)
* [Awesome Compose](https://github.com/docker/awesome-compose) ⭐ 44,642 | 🐛 356 | 🌐 HTML | 📅 2026-03-29 - Docker Compose samples.
* [Awesome Sysadmin](https://github.com/n1trux/awesome-sysadmin) ⭐ 33,407 | 🐛 59 | 📅 2026-03-26 by [n1trux](https://github.com/n1trux)
* [ToolsOfTheTrade](https://github.com/cjbarber/ToolsOfTheTrade) ⭐ 16,985 | 🐛 3 | 📅 2026-03-13 a list of SaaS and On premise applications by [cjbarber](https://github.com/cjbarber)
* [Awesome Kubernetes](https://github.com/ramitsurana/awesome-kubernetes) ⭐ 15,841 | 🐛 50 | 🌐 Shell | 📅 2026-02-27 by [ramitsurana][ramitsurana]
* [Awesome Linux Container](https://github.com/Friz-zy/awesome-linux-containers) ⭐ 2,040 | 🐛 8 | 📅 2024-04-09 more general about container than this repo, by [Friz-zy](https://github.com/Friz-zy).
* [Awesome CI/CD](https://github.com/cicdops/awesome-ciandcd) ⭐ 1,989 | 🐛 19 | 📅 2024-04-01 :ice\_cube: - Not specific to docker but relevant.
...
* [How CVE's are handled on Offical Docker Images](https://github.com/docker-library/official-images/issues/1448) ⭐ 6,945 | 🐛 39 | 🌐 Shell | 📅 2026-03-31
