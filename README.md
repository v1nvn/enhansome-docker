...
* [Docker Curriculum](https://github.com/prakhar1989/docker-curriculum) ⭐ 6,029 | 🐛 94 | 🌐 SCSS | 📅 2026-02-04: A comprehensive tutorial for getting started with Docker. Teaches how to use Docker and deploy dockerized apps on AWS with Elastic Beanstalk and Elastic Container Service.

* [Setting Python Development Environment with VScode and Docker](https://github.com/RamiKrispin/vscode-python) ⭐ 950 | 🐛 4 | 🌐 Shell | 📅 2024-02-02: A step-by-step tutorial for setting up a dockerized Python development environment with VScode, Docker, and the Dev Container extension.

* [Dockerlings](https://github.com/furkan/dockerlings) ⭐ 879 | 🐛 3 | 🌐 Shell | 📅 2026-01-30: Learn docker from inside your terminal, with a modern TUI and bite sized exercises (by [furkan](https://github.com/furkan))

* [The Docker Handbook](https://docker-handbook.farhan.dev/) An open-source book that teaches you the fundamentals, best practices and some intermediate Docker functionalities. The book is hosted on [fhsinchy/the-docker-handbook](https://github.com/fhsinchy/the-docker-handbook) ⭐ 863 | 🐛 5 | 📅 2025-11-01 and the projects are hosted on [fhsinchy/docker-handbook-projects](https://github.com/fhsinchy/docker-handbook-projects) ⭐ 1,391 | 🐛 3 | 🌐 JavaScript | 📅 2025-02-07 repository.
...
* [wsargent](https://github.com/wsargent/docker-cheat-sheet) ⭐ 22,497 | 🐛 7 | 📅 2024-12-31 (Most popular)
* [eon01](https://github.com/eon01/DockerCheatSheet) ⭐ 3,919 | 🐛 1 | 📅 2026-02-19
...
* [Moby](https://github.com/moby/moby) ⭐ 71,540 | 🐛 3,795 | 🌐 Go | 📅 2026-03-18
* [Docker Compose](https://github.com/docker/compose/) ⭐ 37,160 | 🐛 74 | 🌐 Go | 📅 2026-03-18 (Define and run multi-container applications with Docker)
...
* [kompose](https://github.com/kubernetes/kompose) ⭐ 10,472 | 🐛 14 | 🌐 Go | 📅 2026-02-27 - Go from Docker Compose to Kubernetes.
* [podman-compose](https://github.com/containers/podman-compose) ⭐ 6,006 | 🐛 373 | 🌐 Python | 📅 2026-03-15 - A script to run docker-compose.yml using podman.
* [Composerize](https://github.com/magicmark/composerize) ⭐ 3,708 | 🐛 12 | 🌐 JavaScript | 📅 2026-01-17 - Convert docker run commands into docker-compose files.
* [LLM Harbor](https://github.com/av/harbor) ⭐ 2,510 | 🐛 59 | 🌐 TypeScript | 📅 2026-03-16 - A CLI and companion app to effortlessly run LLM backends, APIs, frontends, and services with one command. By [av](https://github.com/av).
...
* [ctk](https://github.com/ctk-hq/ctk) ⭐ 298 | 🐛 10 | 🌐 TypeScript | 📅 2026-02-15 - Visual composer for container based workloads. By [corpulent](https://github.com/corpulent).
...
* [werf](https://github.com/werf/werf) ⭐ 4,663 | 🐛 143 | 🌐 Go | 📅 2026-03-18 - Werf is a CI/CD tool for building Docker images efficiently and deploying them to Kubernetes using GitOps.
...
* [Grafeas](https://github.com/grafeas/grafeas) ⭐ 1,564 | 🐛 61 | 🌐 Go | 📅 2026-03-19 - A common API for metadata about containers, from image and build details to security vulnerabilities. By [grafeas](https://github.com/grafeas).
* [awesome-stacks](https://github.com/ethibox/awesome-stacks) ⭐ 1,257 | 🐛 9 | 🌐 Dockerfile | 📅 2026-03-18 - Deploy 150+ open-source web apps with one Docker command.
...
* [docker-to-iac](https://github.com/deploystackio/docker-to-iac) ⭐ 23 | 🐛 17 | 🌐 TypeScript | 📅 2026-03-16 - Translate docker run and commit into Infrastructure as Code templates for AWS, Render.com and DigitalOcean.
...
* [Glances](https://github.com/nicolargo/glances) ⭐ 32,091 | 🐛 156 | 🌐 Python | 📅 2026-03-17 - A cross-platform curses-based system monitoring tool written in Python.

* [cAdvisor](https://github.com/google/cadvisor) ⭐ 18,984 | 🐛 88 | 🌐 Go | 📅 2026-03-19 - Analyzes resource usage and performance characteristics of running containers.

* [Checkmate](https://github.com/bluewave-labs/checkmate) ⭐ 9,411 | 🐛 89 | 🌐 TypeScript | 📅 2026-03-18 - Checkmate is an open-source, self-hosted tool designed to track and monitor server hardware, uptime, response times, and incidents in real-time with beautiful visualizations.

* [HertzBeat](https://github.com/dromara/hertzbeat) ⭐ 7,130 | 🐛 317 | 🌐 Java | 📅 2026-03-18 - An open-source real-time monitoring system with custom-monitor and agentless.

* [dockprom](https://github.com/stefanprodan/dockprom) ⭐ 6,491 | 🐛 20 | 📅 2026-03-06 - Docker hosts and containers monitoring with Prometheus, Grafana, cAdvisor, NodeExporter and AlertManager.

* [Logspout](https://github.com/gliderlabs/logspout) ⭐ 4,698 | 🐛 108 | 🌐 Go | 📅 2023-07-11 :ice\_cube: - Log routing for Docker container logs.

* [Autoheal](https://github.com/willfarrell/docker-autoheal) ⭐ 1,810 | 🐛 60 | 🌐 Shell | 📅 2025-09-09 - Monitor and restart unhealthy docker containers automatically.
...
* [Doku](https://github.com/amerkurev/doku) ⭐ 410 | 🐛 8 | 🌐 Python | 📅 2025-12-26 - Doku is a simple web-based application that allows you to monitor Docker disk usage. [amerkurev](https://github.com/amerkurev).

* [Drydock](https://github.com/CodesWhat/drydock) ⭐ 157 | 🐛 3 | 🌐 TypeScript | 📅 2026-03-18 - Container update monitoring with web dashboard, 23 registry providers, 20 notification triggers, and distributed agent architecture. By [CodesWhat](https://github.com/CodesWhat).
...
* [DLIA](https://github.com/zorak1103/dlia) ⭐ 3 | 🐛 1 | 🌐 Go | 📅 2026-03-17 - DLIA is an AI-powered Docker log monitoring agent that uses Large Language Models (LLMs) to intelligently analyze container logs, detect anomalies, and provide contextual insights over time. By [zorak1103](https://github.com/zorak1103).

* [DockProbe](https://github.com/deep-on/dockprobe) ⭐ 3 | 🐛 0 | 🌐 Python | 📅 2026-03-18 - Lightweight Docker monitoring dashboard in a single container. Real-time metrics, 6 anomaly detection rules, Telegram alerts, and 16 automated security scans. Zero config, \~50MB RAM. By [DeepOn](https://github.com/deep-on).
...
* [netshoot](https://github.com/nicolaka/netshoot) ⭐ 10,489 | 🐛 43 | 🌐 Shell | 📅 2026-03-05 - The netshoot container has a powerful set of networking tools to help troubleshoot Docker networking issues.
* [MyIP](https://github.com/jason5ng32/MyIP) ⭐ 9,966 | 🐛 0 | 🌐 Vue | 📅 2026-02-10 - All in one IP Toolbox. Easy to check all your IPs, IP geolocation, check for DNS leaks, examine WebRTC connections, speed test, ping test, MTR test, check website availability, whois search and more. By [jason5ng32](https://github.com/jason5ng32).
* [Flannel](https://github.com/coreos/flannel/) ⭐ 9,413 | 🐛 18 | 🌐 Go | 📅 2026-03-19 - Flannel is a virtual network that gives a subnet to each host for use with container runtimes. By [coreos][coreos].
...
* [Kubernetes](https://github.com/kubernetes/kubernetes) ⭐ 121,211 | 🐛 2,594 | 🌐 Go | 📅 2026-03-19 - Open source orchestration system for Docker containers by Google.
* [Rancher](https://github.com/rancher/rancher) ⭐ 25,421 | 🐛 3,261 | 🌐 Go | 📅 2026-03-19 - An open source project that provides a complete platform for operating Docker in production.
* [Nomad](https://github.com/hashicorp/nomad) ⭐ 16,293 | 🐛 1,656 | 🌐 Go | 📅 2026-03-19 - Easily deploy applications at any scale. A Distributed, Highly Available, Datacenter-Aware Scheduler.
* [Mesos](https://github.com/apache/mesos) ⭐ 5,361 | 🐛 11 | 🌐 C++ | 📅 2024-08-23 - Resource/Job scheduler for containers, VM's and physical hosts [apache](https://mesos.apache.org/).
* [docker rollout](https://github.com/Wowu/docker-rollout) ⭐ 3,126 | 🐛 9 | 🌐 Shell | 📅 2026-03-11 - Zero downtime deployment for Docker Compose services.
* [ManageIQ](https://github.com/ManageIQ/manageiq) ⭐ 1,394 | 🐛 333 | 🌐 Ruby | 📅 2026-03-17 - Discover, optimize and control your hybrid IT. By [ManageIQ](https://github.com/ManageIQ).
* [Swarm-cronjob](https://github.com/crazy-max/swarm-cronjob) ⭐ 865 | 🐛 36 | 🌐 Go | 📅 2026-03-19 - Create jobs on a time-based schedule on Swarm by [crazy-max].
* [Crane](https://github.com/Dataman-Cloud/crane) ⭐ 748 | 🐛 15 | 🌐 Go | 📅 2023-08-31 :ice\_cube: - Control plane based on docker built-in swarm [Dataman-Cloud](https://github.com/Dataman-Cloud).
...
* [CloudSlang](https://github.com/CloudSlang/cloud-slang) ⭐ 240 | 🐛 109 | 🌐 Java | 📅 2026-03-18 - CloudSlang is a workflow engine to create Docker process automation.
...
* [Dokku](https://github.com/dokku/dokku) ⭐ 31,922 | 🐛 41 | 🌐 Shell | 📅 2026-03-19 - Docker powered mini-Heroku that helps you build and manage the lifecycle of applications (originally by [progrium][progrium]).
* [caprover](https://github.com/caprover/caprover) ⭐ 14,922 | 🐛 175 | 🌐 TypeScript | 📅 2026-01-31 - \[Previously known as CaptainDuckDuck] Automated Scalable Webserver Package (automated Docker+nginx) - Heroku on Steroids.
* [Tsuru](https://github.com/tsuru/tsuru) ⭐ 5,263 | 🐛 21 | 🌐 Go | 📅 2026-03-19 - Tsuru is an extensible and open source Platform as a Service software.
...
* [Convox Rack](https://github.com/convox/rack) ⭐ 1,891 | 🐛 26 | 🌐 Go | 📅 2026-03-18 - Convox Rack is open source PaaS built on top of expert infrastructure automation and devops best practices.
* [Nanobox](https://github.com/nanobox-io/nanobox) ⭐ 1,625 | 🐛 76 | 🌐 Go | 📅 2019-10-21 :ice\_cube: - :yen: An application development platform that creates local environments that can then be deployed and scaled in the cloud.
...
* [Træfɪk](https://github.com/containous/traefik) ⭐ 62,239 | 🐛 773 | 🌐 Go | 📅 2026-03-18 - Automated reverse proxy and load-balancer for Docker, Mesos, Consul, Etcd... By [EmileVauge](https://github.com/emilevauge).
* [Nginx Proxy Manager](https://github.com/jc21/nginx-proxy-manager) ⭐ 32,145 | 🐛 941 | 🌐 TypeScript | 📅 2026-03-16 - A beautiful web interface for proxying web based services with SSL. By [jc21](https://github.com/jc21).
* [BunkerWeb](https://github.com/bunkerity/bunkerweb) ⭐ 10,170 | 🐛 168 | 🌐 Python | 📅 2026-03-18 - Open-source and next-gen Web Application Firewall (WAF). By [Bunkerity](https://www.bunkerity.com).
* [Let's Encrypt Nginx-proxy Companion](https://github.com/nginx-proxy/docker-letsencrypt-nginx-proxy-companion) ⭐ 7,699 | 🐛 50 | 🌐 Shell | 📅 2026-03-16 - A lightweight companion container for the nginx-proxy. It allow the creation/renewal of Let's Encrypt certificates automatically. By [JrCs](https://github.com/JrCs).
* [fabio](https://github.com/fabiolb/fabio) ⭐ 7,333 | 🐛 240 | 🌐 Go | 📅 2026-03-19 - A fast, modern, zero-conf load balancing HTTP(S) router for deploying microservices managed by consul. By [magiconair](https://github.com/magiconair) (Frank Schroeder).
* [caddy-docker-proxy](https://github.com/lucaslorentz/caddy-docker-proxy) ⭐ 4,340 | 🐛 49 | 🌐 Go | 📅 2026-03-12 - Caddy-based reverse proxy, configured with service or container labels. By [lucaslorentz](https://github.com/lucaslorentz).
* [OpenResty Manager](https://github.com/Safe3/openresty-manager) ⭐ 1,334 | 🐛 54 | 🌐 Go | 📅 2026-01-25 - The easiest using, powerful and beautiful OpenResty Manager(Nginx Enhanced Version), open source alternative to OpenResty Edge. By [Safe3](https://github.com/Safe3/).
...
* [Docker Dnsmasq Updater](https://github.com/moonbuggy/docker-dnsmasq-updater) ⭐ 35 | 🐛 0 | 🌐 Python | 📅 2025-02-09 - Update a remote dnsmasq server with Docker container hostnames.
* [idle-less](https://github.com/tvup/idle-less) ⭐ 14 | 🐛 0 | 🌐 Shell | 📅 2026-03-12 - Reverse proxy with automatic Wake-on-LAN — wakes sleeping backend servers when traffic arrives, shows a waiting screen, and redirects when ready. By [tvup](https://github.com/tvup).
* [mesh-router](https://github.com/Yundera/mesh-router) ⭐ 9 | 🐛 0 | 🌐 TypeScript | 📅 2026-03-02 - Free domain(nsl.sh) provider for Docker containers with automatic HTTPS routing. Uses Wireguard VPN to securely route subdomain requests across networks. Ideal for self-hosted NAS and cloud deployments. By [Yundera](https://github.com/Yundera).
* [nginx-proxy][nginxproxy] - Automated nginx proxy for Docker containers using docker-gen by [jwilder][jwilder]

### Runtime

* [podman](https://github.com/containers/libpod) ⭐ 31,063 | 🐛 1,069 | 🌐 Go | 📅 2026-03-18 - Libpod is a library used to create container pods. Home of Podman.
* [cri-o](https://github.com/cri-o/cri-o) ⭐ 5,590 | 🐛 84 | 🌐 Go | 📅 2026-03-19 - Open Container Initiative-based implementation of Kubernetes Container Runtime Interface by [cri-o](https://github.com/cri-o).
* [lxc](https://github.com/lxc/lxc) ⭐ 5,130 | 🐛 170 | 🌐 C | 📅 2026-03-15 - LXC - Linux Containers.
...
* [Trivy](https://github.com/aquasecurity/trivy) ⭐ 33,202 | 🐛 226 | 🌐 Go | 📅 2026-03-19 - Aqua Security's open source simple and comprehensive vulnerability scanner for containers (suitable for CI).
* [Clair](https://github.com/quay/clair) ⭐ 10,945 | 🐛 55 | 🌐 Go | 📅 2026-03-19 - Clair is an open source project for the static analysis of vulnerabilities in appc and docker containers. By [coreos][coreos].
* [docker-bench-security](https://github.com/docker/docker-bench-security) ⭐ 9,604 | 🐛 26 | 🌐 Shell | 📅 2024-10-21 - Script that checks for dozens of common best-practices around deploying Docker containers in production. By [docker][docker].
* [Sysdig Falco](https://github.com/falcosecurity/falco) ⭐ 8,745 | 🐛 49 | 🌐 C++ | 📅 2026-03-18 - Sysdig Falco is an open source container security monitor. It can monitor application, container, host, and network activity and alert on unauthorized activity.
* [Checkov](https://github.com/bridgecrewio/checkov) ⭐ 8,542 | 🐛 151 | 🌐 Python | 📅 2026-03-18 - Static analysis for infrastructure as code manifests (Terraform, Kubernetes, Cloudformation, Helm, Dockerfile, Kustomize) find security misconfiguration and fix them. By [bridgecrew](https://github.com/bridgecrewio).
* [Syft](https://github.com/anchore/syft) ⭐ 8,526 | 🐛 541 | 🌐 Go | 📅 2026-03-18 - CLI tool and library for generating a Software Bill of Materials (SBOM) from container images and filesystems.
* [Deepfence Threat Mapper](https://github.com/deepfence/ThreatMapper) ⭐ 5,239 | 🐛 142 | 🌐 TypeScript | 📅 2026-03-08 - Powerful runtime vulnerability scanner for kubernetes, virtual machines and serverless. By [deepfence][deepfence].
* [KICS](https://github.com/checkmarx/kics) ⭐ 2,589 | 🐛 279 | 🌐 Open Policy Agent | 📅 2026-03-19 - An infrastructure-as-code scanning tool, find security vulnerabilities, compliance issues, and infrastructure misconfigurations early in the development cycle. Can be extended for additional policies. By [Checkmarx](https://github.com/Checkmarx).
* [oscap-docker](https://github.com/OpenSCAP/openscap) ⭐ 1,680 | 🐛 63 | 🌐 XSLT | 📅 2026-02-27 - OpenSCAP provides oscap-docker tool which is used to scan Docker containers and images. By [OpenSCAP](https://github.com/OpenSCAP).
* [bane](https://github.com/genuinetools/bane) ⭐ 1,224 | 🐛 4 | 🌐 Go | 📅 2020-09-17 :ice\_cube: - AppArmor profile generator for Docker containers.
* [Dagda](https://github.com/eliasgranderubio/dagda) ⭐ 1,222 | 🐛 25 | 🌐 Python | 📅 2023-05-23 :ice\_cube: - Dagda is a tool to perform static analysis of known vulnerabilities, trojans, viruses, malware & other malicious threats in docker images/containers and to monitor the docker daemon and running docker containers for detecting anomalous activities. By [eliasgranderubio](https://github.com/eliasgranderubio).
* [docker-explorer](https://github.com/google/docker-explorer) ⭐ 553 | 🐛 11 | 🌐 Python | 📅 2024-10-04 - A tool to help forensicate offline docker acquisitions.
...
* [crowdsec-blocklist-import](https://github.com/wolffcatskyy/crowdsec-blocklist-import) ⭐ 186 | 🐛 1 | 🌐 Python | 📅 2026-03-18 - Aggregates 36 free threat intelligence feeds into 120k+ malicious IPs for CrowdSec bouncers, providing 10-20x more blocks than default lists. By [wolffcatskyy](https://github.com/wolffcatskyy).
* [CetusGuard](https://github.com/hectorm/cetusguard) ⭐ 82 | 🐛 2 | 🌐 Go | 📅 2026-03-01 - CetusGuard is a tool that protects the Docker daemon socket by filtering calls to its API endpoints.
...
* [etcd](https://github.com/etcd-io/etcd) ⭐ 51,658 | 🐛 225 | 🌐 Go | 📅 2026-03-19 - Distributed reliable key-value store for the most critical data of a distributed system by [etcd-io](https://github.com/etcd-io) (former part of CoreOS).
* [istio](https://github.com/istio/istio) ⭐ 38,072 | 🐛 516 | 🌐 Go | 📅 2026-03-19 - An open platform to connect, manage, and secure microservices.
* [registrator](https://github.com/gliderlabs/registrator) ⭐ 4,676 | 🐛 258 | 🌐 Go | 📅 2025-05-22 - Service registry bridge for Docker by [gliderlabs][gliderlabs] and [progrium][progrium].
...
* [Docker Volume Backup](https://github.com/offen/docker-volume-backup) ⭐ 3,439 | 🐛 28 | 🌐 Go | 📅 2026-03-19 Backup Docker volumes locally or to any S3 compatible storage. By [offen](https://github.com/offen)

* [REX-Ray](https://github.com/rexray/rexray) ⭐ 2,220 | 🐛 294 | 🌐 Go | 📅 2023-09-02 provides a vendor agnostic storage orchestration engine. The primary design goal is to provide persistent storage for Docker, Kubernetes, and Mesos. By[thecodeteam](https://github.com/thecodeteam) (DELL Technologies)
...
* [duplicacy-cli-cron](https://github.com/GeiserX/duplicacy-cli-cron) ⭐ 1 | 🐛 0 | 🌐 Shell | 📅 2026-03-10 - Docker-based encrypted dual-storage backup automation using Duplicacy CLI with cross-site redundancy and Telegram notifications. By [GeiserX](https://github.com/GeiserX).
...
* [Stevedore](https://github.com/slonopotamus/stevedore) ⭐ 369 | 🐛 2 | 🌐 Rust | 📅 2026-02-27 - Good Docker Desktop replacement for Windows. Both Linux and Windows Containers are supported. [slonopotamus](https://github.com/slonopotamus).
* [Docker DB Manager](https://github.com/AbianS/docker-db-manager) ⭐ 155 | 🐛 10 | 🌐 TypeScript | 📅 2025-11-26 - Desktop app for managing Docker database containers with visual interface and one-click operations.
...
* [dive](https://github.com/wagoodman/dive) ⭐ 53,604 | 🐛 203 | 🌐 Go | 📅 2025-12-15 - A tool for exploring each layer in a docker image. By [wagoodman](https://github.com/wagoodman).
* [lazydocker](https://github.com/jesseduffield/lazydocker) ⭐ 50,209 | 🐛 259 | 🌐 Go | 📅 2026-03-15 - The lazier way to manage everything docker. A simple terminal UI for both docker and docker-compose, written in Go with the gocui library. By [jesseduffield](https://github.com/jesseduffield).
* [dockly](https://github.com/lirantal/dockly) ⭐ 4,015 | 🐛 3 | 🌐 JavaScript | 📅 2026-02-01 - An interactive shell UI for managing Docker containers.
* [dry](https://github.com/moncho/dry) ⭐ 3,230 | 🐛 31 | 🌐 Go | 📅 2026-03-18 - An interactive CLI for Docker containers.
* [DockSTARTer](https://github.com/GhostWriters/DockSTARTer) ⭐ 2,549 | 🐛 9 | 🌐 Shell | 📅 2026-03-18 - DockSTARTer helps you get started with home server apps running in Docker by [GhostWriters](https://github.com/GhostWriters).
* [oxker](https://github.com/mrjackwills/oxker) ⭐ 1,567 | 🐛 21 | 🌐 Rust | 📅 2026-02-23 - A simple tui to view & control docker containers. Written in [Rust](https://rust-lang.org/), making heavy use of [ratatui](https://github.com/tui-rs-revival/ratatui) ⭐ 19,149 | 🐛 194 | 🌐 Rust | 📅 2026-03-18 & [Bollard](https://github.com/fussybeaver/bollard) ⭐ 1,232 | 🐛 47 | 🌐 Rust | 📅 2026-03-18,.
* [lazyjournal](https://github.com/Lifailon/lazyjournal) ⭐ 1,190 | 🐛 0 | 🌐 Go | 📅 2026-03-16 - A interface for reading and filtering the logs output of Docker and Podman containers like [Dozzle](origin/dozzle) but for the terminal with support for fuzzy find, regex and output coloring.
* [goManageDocker](https://github.com/ajayd-san/gomanagedocker) ⭐ 632 | 🐛 12 | 🌐 Go | 📅 2024-12-28 - TUI tool to view and manage your docker objects blazingly fast with sensible keybindings, also supports VIM navigation out of the box.
* [DockMate](https://github.com/shubh-io/dockmate) ⭐ 286 | 🐛 1 | 🌐 Go | 📅 2026-01-14 - Lightweight terminal-based Docker and Podman manager with a text-based user interface,.
* [dockdash](https://github.com/byrnedo/dockdash) ⭐ 125 | 🐛 0 | 🌐 Go | 📅 2022-06-01 detailed stats. By [byrnedo]
* [d4s](https://github.com/jr-k/d4s) ⭐ 59 | 🐛 0 | 🌐 Go | 📅 2026-03-16 - A fast, keyboard-driven terminal UI to manage Docker containers, Compose stacks, and Swarm services with the ergonomics of K9s.
...
* [skopeo](https://github.com/containers/skopeo) ⭐ 10,581 | 🐛 74 | 🌐 Go | 📅 2026-03-16 - Work with remote images registries - retrieving information, images, signing content.

* [DVM](https://github.com/howtowhale/dvm) ⭐ 526 | 🐛 16 | 🌐 Go | 📅 2022-03-30 :ice\_cube: - Docker version manager.
...
* [decompose](https://github.com/s0rg/decompose) ⭐ 127 | 🐛 1 | 🌐 Go | 📅 2026-03-15 - Reverse-engineering tool for docker environments. By [s0rg](https://github.com/s0rg).
...
* [supdock](https://github.com/segersniels/supdock) ⭐ 86 | 🐛 0 | 🌐 Rust | 📅 2026-02-23 - Allows for slightly more visual usage of Docker with an interactive prompt. By [segersniels](https://github.com/segersniels).
...
* [dctl](https://github.com/FabienD/docker-stack) ⭐ 22 | 🐛 1 | 🌐 Rust | 📅 2026-03-01 - Dctl is a Cli tool that helps developers by allowing them to execute all docker compose commands anywhere in the terminal, and more. By [FabienD](https://github.com/FabienD).
...
* [docker-captain](https://github.com/lucabello/docker-captain) ⭐ 2 | 🐛 1 | 🌐 Python | 📅 2026-03-07 - A friendly CLI to manage multiple Docker Compose deployments with style — powered by Typer, Rich, questionary, and sh.
...
* [netdata](https://github.com/netdata/netdata) ⭐ 78,124 | 🐛 245 | 🌐 C | 📅 2026-03-19 - Real-time performance monitoring.
* [Portainer](https://github.com/portainer/portainer) ⭐ 36,891 | 🐛 728 | 🌐 TypeScript | 📅 2026-03-18 - A lightweight management UI for managing your Docker hosts or Docker Swarm clusters.
* [dockge](https://github.com/louislam/dockge) ⭐ 22,511 | 🐛 143 | 🌐 TypeScript | 📅 2026-01-21 - Easy-to-use and reactive self-hosted docker compose.yaml stack-oriented manager.
* [Theia](https://github.com/eclipse-theia/theia) ⭐ 21,405 | 🐛 1,454 | 🌐 TypeScript | 📅 2026-03-18 - Extensible platform to develop full-fledged multi-language Cloud & Desktop IDE-like products with state-of-the-art web technologies.
* [Komodo](https://github.com/mbecker20/komodo) ⭐ 10,578 | 🐛 426 | 🌐 Rust | 📅 2026-03-16 - A tool to build and deploy software on many servers.
...
* [Arcane](https://github.com/getarcaneapp/arcane) ⭐ 5,012 | 🐛 135 | 🌐 Go | 📅 2026-03-19 - An easy and modern Docker management platform, built with everybody in mind. By [getarcaneapp](https://github.com/getarcaneapp).
* [Swarmpit](https://github.com/swarmpit/swarmpit) ⭐ 3,415 | 🐛 194 | 🌐 Clojure | 📅 2026-03-04 - Swarmpit provides simple and easy to use interface for your Docker Swarm cluster. You can manage your stacks, services, secrets, volumes, networks etc.
* [docker-swarm-visualizer](https://github.com/dockersamples/docker-swarm-visualizer) ⭐ 3,348 | 🐛 11 | 🌐 JavaScript | 📅 2024-10-26 - Visualizes Docker services on a Docker Swarm (for running demos).
* [Seagull](https://github.com/tobegit3hub/seagull) ⭐ 1,939 | 🐛 20 | 🌐 JavaScript | 📅 2017-11-22 :ice\_cube: - Friendly Web UI to monitor docker daemon.
* [Kubevious](https://github.com/kubevious/kubevious) ⭐ 1,691 | 🐛 17 | 📅 2024-01-15 :ice\_cube: - A highly visual web UI for Kubernetes which renders configuration and state in an application centric way.
* [dockemon](https://github.com/ProductiveOps/dokemon) ⭐ 760 | 🐛 18 | 🌐 TypeScript | 📅 2024-02-21 :ice\_cube: - Docker Container Management GUI.
* [Mafl](https://github.com/hywax/mafl) ⭐ 678 | 🐛 45 | 🌐 TypeScript | 📅 2025-10-26 - Minimalistic flexible homepage.
* [Docker Registry Browser](https://github.com/klausmeyer/docker-registry-browser) ⭐ 677 | 🐛 9 | 🌐 Ruby | 📅 2026-03-18 - Web Interface for the Docker Registry HTTP API v2.
...
* [Container Web TTY](https://github.com/wrfly/container-web-tty) ⭐ 258 | 🐛 9 | 🌐 Go | 📅 2026-03-19 - Connect your containers via a web-tty [wrfly](https://github.com/wrfly).
...
* [CASA](https://github.com/knrdl/casa) ⭐ 84 | 🐛 0 | 🌐 Svelte | 📅 2026-03-17 - Outsource the administration of a handful of containers to your co-workers,.
* [usulnet](https://github.com/fr4nsys/usulnet) ⭐ 81 | 🐛 2 | 🌐 Go | 📅 2026-02-23 - A complete and modern Docker management platform designed for sysadmin, devops with enterprise grade tools, cve scanner, ssh, rdp on web and much more. By [fr4nsys](https://github.com/fr4nsys).
...
* [distroless](https://github.com/GoogleContainerTools/distroless) ⭐ 22,386 | 🐛 16 | 🌐 Starlark | 📅 2026-03-16 - Language focused docker images, minus the operating system,.

* [docker-alpine](https://github.com/gliderlabs/docker-alpine) ⭐ 5,719 | 🐛 123 | 🌐 Shell | 📅 2021-04-01 :ice\_cube: - A super small Docker base image *(5MB)* using Alpine Linux.

* [GoSu](https://github.com/tianon/gosu) ⭐ 4,956 | 🐛 7 | 🌐 Shell | 📅 2026-03-04 - Run this specific application as this specific user and get out of the pipeline (entrypoint script tool).

* [docker-gen](https://github.com/jwilder/docker-gen) ⭐ 4,620 | 🐛 51 | 🌐 Go | 📅 2026-03-17 - Generate files from docker container meta-data.

* [Ofelia](https://github.com/mcuadros/ofelia/) ⭐ 3,762 | 🐛 145 | 🌐 Go | 📅 2026-03-19 - Ofelia is a modern and low footprint job scheduler for docker environments, built on Go. Ofelia aims to be a replacement for the old fashioned cron. Supports configuration from container labels and/or configuration files.

* [supercronic](https://github.com/aptible/supercronic) ⭐ 2,416 | 🐛 45 | 🌐 Go | 📅 2026-03-12 - Crontab-compatible job runner, designed specifically to run in containers.

* [amicontained](https://github.com/genuinetools/amicontained) ⭐ 1,074 | 🐛 7 | 🌐 Go | 📅 2020-12-09 :ice\_cube: - Container introspection tool. Find out what container runtime is being used as well as features available.
...
* [dockerize](https://github.com/powerman/dockerize) ⭐ 195 | 🐛 6 | 🌐 Go | 📅 2026-03-19 - Utility to simplify running applications in docker containers by [jwilder][jwilder], [powerman][powerman].

* [Chaperone](https://github.com/garywiz/chaperone) ⭐ 179 | 🐛 19 | 🌐 Python | 📅 2020-07-16 :ice\_cube: - A single PID1 process designed for docker containers. Does user management, log management, startup, zombie reaping, all in one small package.

* [microcheck](https://github.com/tarampampam/microcheck) ⭐ 136 | 🐛 0 | 🌐 C | 📅 2026-02-24 - Lightweight health check utilities for Docker containers (75 KB instead of 9.3 MB for httpcheck versus cURL) in pure C - http(s), port checks, and parallel execution are included.
...
* [DockerSlim](https://github.com/docker-slim/docker-slim) ⭐ 23,081 | 🐛 206 | 🌐 Go | 📅 2026-03-15 shrinks fat Docker images creating the smallest possible images.

* [BuildKit](https://github.com/moby/buildkit) ⭐ 9,841 | 🐛 936 | 🌐 Go | 📅 2026-03-19 - Concurrent, cache-efficient, and Dockerfile-agnostic builder toolkit.

* [buildah](https://github.com/containers/buildah) ⭐ 8,676 | 🐛 247 | 🌐 Go | 📅 2026-03-18 - A tool that facilitates building OCI images.
...
* [runlike](https://github.com/lavie/runlike) ⭐ 2,921 | 🐛 7 | 🌐 Python | 📅 2025-12-04 - Generate `docker run`command and options from running containers.

* [Whaler](https://github.com/P3GLEG/Whaler) ⭐ 1,185 | 🐛 6 | 🌐 Go | 📅 2026-03-19 - Program to reverse Docker images into Dockerfiles.
...
* [Derrick](https://github.com/alibaba/derrick) ⭐ 692 | 🐛 12 | 🌐 Go | 📅 2023-03-06 :ice\_cube: - A tool help you to automate the generation of Dockerfile and dockerize application by scanning the code. By [alibaba](https://github.com/alibaba).

* [RAUDI](https://github.com/cybersecsi/RAUDI) ⭐ 561 | 🐛 5 | 🌐 Python | 📅 2026-03-18 - A tool to automatically update (and optionally push to Docker Hub) Docker Images for 3rd party software whenever theres is a new release/update/commit. By [SecSI](https://github.com/cybersecsi).
...
* [dlayer](https://github.com/orisano/dlayer) ⭐ 445 | 🐛 6 | 🌐 Go | 📅 2026-03-12 - Docker layer analyzer.
...
* [docker-replay](https://github.com/bcicen/docker-replay) ⭐ 203 | 🐛 0 | 🌐 Python | 📅 2018-10-13 :ice\_cube: - Generate `docker run`command and options from running containers. By [bcicen](https://github.com/bcicen).
...
* [cekit](https://github.com/cekit/cekit) ⭐ 113 | 🐛 29 | 🌐 Python | 📅 2026-01-30 - A tool used by openshift to build base images using different build engines.
...
* [dockerfilegraph](https://github.com/patrickhoefler/dockerfilegraph) ⭐ 257 | 🐛 0 | 🌐 Go | 📅 2026-03-16 - Visualize your multi-stage Dockerfiles. By [PatrickHoefler](https://github.com/patrickhoefler).
...
* [Dockershelf](https://github.com/Dockershelf/dockershelf) ⭐ 97 | 🐛 0 | 🌐 Shell | 📅 2026-03-12 - A repository that serves as a collector for docker recipes that are universal, efficient and slim. Images are updated, tested and published daily via a Travis cron job.
...
* [jessfraz](https://github.com/jessfraz/dockerfiles) ⭐ 13,941 | 🐛 79 | 🌐 Dockerfile | 📅 2024-07-06
* [vimagick](https://github.com/vimagick/dockerfiles) ⭐ 3,202 | 🐛 82 | 🌐 Dockerfile | 📅 2026-02-23
...
* [Hadolint](https://github.com/hadolint/hadolint) ⭐ 12,010 | 🐛 256 | 🌐 Haskell | 📅 2026-03-09 - A Dockerfile linter that checks for best practices, common mistakes, and is also able to lint any bash written in `RUN` instructions;.
...
* [Dockadvisor](https://github.com/deckrun/dockadvisor) ⭐ 197 | 🐛 0 | 🌐 Go | 📅 2026-01-12 - Lightweight Dockerfile linter with 60+ rules, quality scoring, and security checks.
* [docker-image-size-limit](https://github.com/wemake-services/docker-image-size-limit) ⭐ 130 | 🐛 1 | 🌐 Python | 📅 2026-03-13 - A tool to keep an eye on your docker images size.
...
* [opencontainer](https://github.com/opencontainers/image-spec/blob/main/annotations.md) ⭐ 4,187 | 🐛 74 | 🌐 Go | 📅 2026-02-26 - A convention and shared namespace for Docker labels defined by OCI Image Spec.

### Registry

Services to securely store your Docker images.

* [Harbor](https://github.com/goharbor/harbor) ⭐ 27,758 | 🐛 806 | 🌐 Go | 📅 2026-03-18 An open source trusted cloud native registry project that stores, signs, and scans content. Supports replication, user management, access control and activity auditing. By [CNCF](https://www.cncf.io) formerly [VMWare][vmware]
* [Kraken](https://github.com/uber/kraken) ⭐ 6,668 | 🐛 117 | 🌐 Go | 📅 2026-03-18 - Uber's Highly scalable P2P docker registry, capable of distributing TBs of data in seconds.
* [Dragonfly](https://github.com/dragonflyoss/Dragonfly2) ⭐ 3,087 | 🐛 27 | 🌐 Go | 📅 2026-03-19 - Provide efficient, stable and secure file distribution and image acceleration based on p2p technology.
...
* [dockerode](https://github.com/apocas/dockerode) ⭐ 4,854 | 🐛 27 | 🌐 JavaScript | 📅 2026-02-28 - Docker Remote API node.js module.
* [Docker.DotNet](https://github.com/Microsoft/Docker.DotNet) ⭐ 2,406 | 🐛 187 | 🌐 C# | 📅 2025-08-28 - C#/.NET HTTP client for the Docker remote API.
* [go-dockerclient](https://github.com/fsouza/go-dockerclient/) ⭐ 2,234 | 🐛 13 | 🌐 Go | 📅 2026-03-19 - Go HTTP client for the Docker remote API.
* [docker-maven-plugin](https://github.com/fabric8io/docker-maven-plugin) ⭐ 1,929 | 🐛 516 | 🌐 Java | 📅 2026-02-24 - A Maven plugin for running and creating Docker images.
...
* [docker-controller-bot](https://github.com/dgongut/docker-controller-bot) ⭐ 242 | 🐛 11 | 🌐 Python | 📅 2026-02-04 - Telegram bot to control docker containers. By [dgongut](https://github.com/dgongut/).
* [contajners](https://github.com/lispyclouds/contajners) ⭐ 146 | 🐛 0 | 🌐 Clojure | 📅 2026-03-14 - An idiomatic, data-driven, REPL friendly Clojure client for OCI container engines. By [lispyclouds][lispyclouds].
* [ahab](https://github.com/instacart/ahab) ⭐ 137 | 🐛 1 | 🌐 Python | 📅 2018-11-16 :ice\_cube: - Docker event handling with Python.
* [Docker Client for JVM](https://github.com/gesellix/docker-client) ⭐ 119 | 🐛 26 | 🌐 Groovy | 📅 2026-03-18 - A Docker remote api client library for the JVM, written in Groovy.
* [Gradle Docker plugin](https://github.com/gesellix/gradle-docker-plugin) ⭐ 81 | 🐛 16 | 🌐 Java | 📅 2026-03-18 - A Docker remote api plugin for Gradle.
...
* [Drone](https://github.com/drone/drone) ⭐ 33,924 | 🐛 86 | 🌐 Go | 📅 2026-03-19 - Continuous integration server built on Docker and configured using YAML files.
* [Diun](https://github.com/crazy-max/diun) ⭐ 4,501 | 🐛 96 | 🌐 Go | 📅 2026-03-18 - Receive notifications when an image or repository is updated on a Docker registry by [crazy-max].
* [dockcheck](https://github.com/mag37/dockcheck) ⭐ 2,248 | 🐛 11 | 🌐 Shell | 📅 2026-03-12 - A script checking updates for docker images without pulling then auto-update selected/all containers. With notifications, pruning and more.
* [Cyclone](https://github.com/caicloud/cyclone) ⭐ 1,073 | 🐛 44 | 🌐 Go | 📅 2023-10-24 :ice\_cube: - Powerful workflow engine and end-to-end pipeline solutions implemented with native Kubernetes resources.
...
* [Defang](https://github.com/DefangLabs/defang) ⭐ 147 | 🐛 204 | 🌐 Go | 📅 2026-03-19 - Deploy Docker Compose to your favorite cloud in minutes.
...
* [Gantry](https://github.com/shizunge/gantry) ⭐ 86 | 🐛 2 | 🌐 Shell | 📅 2026-03-19 - Automatically update selected Docker swarm services.
...
* [coder](https://github.com/coder/coder) ⭐ 12,573 | 🐛 875 | 🌐 Go | 📅 2026-03-19 - Remote development machines powered by Terraform or Docker.
* [Eclipse Che](https://github.com/eclipse/che) ⭐ 7,146 | 🐛 276 | 🌐 TypeScript | 📅 2026-03-18 - Developer workspace server with Docker runtimes, cloud IDE, next-generation Eclipse IDE.
* [Lando](https://github.com/lando/lando) ⭐ 4,221 | 🐛 176 | 📅 2026-02-24 - Lando is for developers who want to quickly specify and painlessly spin up the services and tools needed to develop their projects. By [Tandem](https://www.thinktandem.io/).
...
* [DIP](https://github.com/bibendi/dip) ⭐ 1,324 | 🐛 15 | 🌐 Ruby | 📅 2024-12-25 - CLI utility for straightforward provisioning and interacting with an application configured by docker-compose. By [bibendi](https://github.com/bibendi).
* [Zsh-in-Docker](https://github.com/deluan/zsh-in-docker) ⭐ 1,096 | 🐛 9 | 🌐 Shell | 📅 2024-09-30 - Install Zsh, Oh-My-Zsh and plugins inside a Docker container with one line! By [Deluan](https://www.deluan.com).
...
* [Gebug](https://github.com/moshebe/gebug) ⭐ 634 | 🐛 21 | 🌐 Go | 📅 2026-03-12 - A tool that makes debugging of Dockerized Go applications super easy by enabling Debugger and Hot-Reload features, seamlessly.
...
* [Docker Clean](https://github.com/ZZROTDesign/docker-clean) ⭐ 1,301 | 🐛 10 | 🌐 Shell | 📅 2018-01-16 :ice\_cube: - A script that cleans Docker containers, images and volumes.
* [Docuum](https://github.com/stepchowfun/docuum) ⭐ 684 | 🐛 13 | 🌐 Rust | 📅 2026-03-07 - Least recently used (LRU) eviction of Docker images.
...
* [OpenFaaS](https://github.com/openfaas/faas) ⭐ 26,116 | 🐛 31 | 🌐 Go | 📅 2026-03-09 - A complete serverless functions framework for Docker and Kubernetes. By [OpenFaaS](https://github.com/openfaas).

* [Apache OpenWhisk](https://github.com/apache/openwhisk) ⭐ 6,758 | 🐛 433 | 🌐 Scala | 📅 2026-01-24 - A serverless, open source cloud platform that executes functions in response to events at any scale. By [apache](https://github.com/apache).

* [IronFunctions](https://github.com/iron-io/functions) ⭐ 3,218 | 🐛 95 | 🌐 Go | 📅 2023-09-15 :ice\_cube: - The serverless microservices platform FaaS (Functions as a Service) which uses Docker containers to run Any language or AWS Lambda functions.
...
* [dgoss](https://github.com/goss-org/goss/tree/master/extras/dgoss) ⭐ 5,870 | 🐛 93 | 🌐 Go | 📅 2025-05-01 - A fast YAML based tool for validating docker containers.
* [Pumba](https://github.com/alexei-led/pumba) ⭐ 3,000 | 🐛 11 | 🌐 Go | 📅 2026-03-19 - Chaos testing tool for Docker. Can be deployed on kubernetes and CoreOS cluster. By [alexei-led](https://github.com/alexei-led).
* [Container Structure Test](https://github.com/GoogleContainerTools/container-structure-test) ⭐ 2,466 | 🐛 112 | 🌐 Go | 📅 2026-03-16 - A framework to validate the structure of an image by checking the outputs of commands or the contents of the filesystem. By [GoogleContainerTools][googlecontainertools].
* [Kurtosis](https://github.com/kurtosis-tech/kurtosis) ⭐ 527 | 🐛 289 | 🌐 Go | 📅 2026-03-18 - A composable build system for multi-container test environments that provides developers with: a powerful Python-like SDK for environment configuration, a compile-time validator to verify environment behavior & setup, and a runtime for environment execution, monitoring, & debugging capabilities. By [Kurtosis](https://www.kurtosis.com/).
...
* [udocker](https://github.com/indigo-dc/udocker) ⭐ 1,714 | 🐛 37 | 🌐 Python | 📅 2025-08-13 - A tool to execute simple docker containers in batch or interactive systems without root privileges.
...
* [Terraform cloud-init config](https://github.com/christippett/terraform-cloudinit-container-server) ⭐ 120 | 🐛 4 | 🌐 HCL | 📅 2022-08-19 :ice\_cube: - Terraform module for deploying a single Docker image or `docker-compose.yaml` file to any Cloud™ VM.
...
* [Hokusai](https://github.com/artsy/hokusai) ⭐ 98 | 🐛 22 | 🌐 Python | 📅 2026-03-06 - A Docker + Kubernetes CLI for application developers; used to containerize an application and to manage its lifecycle throughout development, testing, and release cycles. From [artsy](https://github.com/artsy).
* [dockerized](https://github.com/benzaita/dockerized-cli) ⭐ 64 | 🐛 0 | 🌐 Python | 📅 2024-02-27 :ice\_cube: - Seamlessly execute commands in a container.
...
* [Cloud Native Landscape](https://github.com/cncf/landscape) ⭐ 9,841 | 🐛 39 | 📅 2026-03-18
...
* [Awesome Selfhosted](https://github.com/awesome-selfhosted/awesome-selfhosted) ⭐ 280,848 | 🐛 0 | 📅 2026-03-16 list of Free Software network services and web applications which can be hosted locally by running in a classical way (setup local web server and run applications from there) or in a Docker container. By [Kickball](https://github.com/Kickball)
* [Awesome Compose](https://github.com/docker/awesome-compose) ⭐ 44,435 | 🐛 351 | 🌐 HTML | 📅 2026-03-19 - Docker Compose samples.
* [Awesome Sysadmin](https://github.com/n1trux/awesome-sysadmin) ⭐ 33,247 | 🐛 68 | 📅 2026-03-17 by [n1trux](https://github.com/n1trux)
* [ToolsOfTheTrade](https://github.com/cjbarber/ToolsOfTheTrade) ⭐ 16,965 | 🐛 2 | 📅 2026-03-13 a list of SaaS and On premise applications by [cjbarber](https://github.com/cjbarber)
* [Awesome Kubernetes](https://github.com/ramitsurana/awesome-kubernetes) ⭐ 15,834 | 🐛 48 | 🌐 Shell | 📅 2026-02-27 by [ramitsurana][ramitsurana]
* [Awesome Linux Container](https://github.com/Friz-zy/awesome-linux-containers) ⭐ 2,037 | 🐛 7 | 📅 2024-04-09 more general about container than this repo, by [Friz-zy](https://github.com/Friz-zy).
* [Awesome CI/CD](https://github.com/cicdops/awesome-ciandcd) ⭐ 1,987 | 🐛 19 | 📅 2024-04-01 :ice\_cube: - Not specific to docker but relevant.
...
* [How CVE's are handled on Offical Docker Images](https://github.com/docker-library/official-images/issues/1448) ⭐ 6,938 | 🐛 39 | 🌐 Shell | 📅 2026-03-18
