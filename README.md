...
All the links are monitored and tested with a home baked [Node.js script](https://github.com/veggiemonk/awesome-docker/blob/master/.github/workflows/pull_request.yml) ⭐ 35,393 | 🐛 9 | 📅 2026-02-03
...
* [Docker Curriculum](https://github.com/prakhar1989/docker-curriculum) ⭐ 6,014 | 🐛 94 | 🌐 SCSS | 📅 2026-02-04: A comprehensive tutorial for getting started with Docker. Teaches how to use Docker and deploy dockerized apps on AWS with Elastic Beanstalk and Elastic Container Service.

* [Setting Python Development Environment with VScode and Docker](https://github.com/RamiKrispin/vscode-python) ⭐ 944 | 🐛 4 | 🌐 Shell | 📅 2024-02-02: A step-by-step tutorial for setting up a dockerized Python development environment with VScode, Docker, and the Dev Container extension.

* [The Docker Handbook](https://docker-handbook.farhan.dev/) An open-source book that teaches you the fundamentals, best practices and some intermediate Docker functionalities. The book is hosted on [fhsinchy/the-docker-handbook](https://github.com/fhsinchy/the-docker-handbook) ⭐ 858 | 🐛 5 | 📅 2025-11-01 and the projects are hosted on [fhsinchy/docker-handbook-projects](https://github.com/fhsinchy/docker-handbook-projects) ⭐ 1,390 | 🐛 3 | 🌐 JavaScript | 📅 2025-02-07 repository.

* [Dockerlings](https://github.com/furkan/dockerlings) ⭐ 834 | 🐛 1 | 🌐 Shell | 📅 2026-01-30: Learn docker from inside your terminal, with a modern TUI and bite sized exercises (by [furkan](https://github.com/furkan))

* [Docker katas](https://github.com/eficode-academy/docker-katas) ⭐ 282 | 🐛 13 | 🌐 Dockerfile | 📅 2025-10-20 A series of labs that will take you from "Hello Docker" to deploying a containerized web application to a server.
...
* [Docker for beginners](https://github.com/groda/big_data/blob/master/docker_for_beginners.md) ⭐ 85 | 🐛 0 | 🌐 Jupyter Notebook | 📅 2026-02-04: A tutorial for beginners who need to learn the basics of Docker—from "Hello world!" to basic interactions with containers, with simple explanations of the underlying concepts.
...
* [@eon01](https://github.com/eon01/DockerCheatSheet) ⭐ 3,897 | 🐛 1 | 📅 2026-01-16
...
* [Moby](https://github.com/moby/moby) ⭐ 71,452 | 🐛 3,788 | 🌐 Go | 📅 2026-02-06
* [Docker Compose](https://github.com/docker/compose/) ⭐ 36,949 | 🐛 51 | 🌐 Go | 📅 2026-02-03 (Define and run multi-container applications with Docker)
...
* [bocker](https://github.com/p8952/bocker) ⭐ 12,614 | 🐛 14 | 🌐 Shell | 📅 2017-12-09 (1) :skull: - Docker implemented in 100 lines of bash by [p8952](https://github.com/p8952)
* [kompose](https://github.com/kubernetes/kompose) ⭐ 10,430 | 🐛 11 | 🌐 Go | 📅 2026-02-02 - Go from Docker Compose to Kubernetes
* [podman-compose](https://github.com/containers/podman-compose) ⭐ 5,939 | 🐛 385 | 🌐 Python | 📅 2026-01-25 - a script to run docker-compose.yml using podman by [@containers][containers]
* [Composerize](https://github.com/magicmark/composerize) ⭐ 3,686 | 🐛 12 | 🌐 JavaScript | 📅 2026-01-17 - Convert docker run commands into docker-compose files
* [LLM Harbor](https://github.com/av/harbor) ⭐ 2,406 | 🐛 56 | 🌐 Python | 📅 2026-02-06 - A CLI and companion app to effortlessly run LLM backends, APIs, frontends, and services with one command. By [@av](https://github.com/av)
* [habitus](https://github.com/cloud66-oss/habitus) ⭐ 1,392 | 🐛 8 | 🌐 Go | 📅 2020-02-05 - A Build Flow Tool for Docker by [@cloud66](https://github.com/cloud66)
...
* [ctk](https://github.com/ctk-hq/ctk) ⭐ 296 | 🐛 14 | 🌐 TypeScript | 📅 2022-09-08 :construction: - Visual composer for container based workloads. By [@corpulent](https://github.com/corpulent)
...
* [docker-compose-graphviz](https://github.com/abesto/docker-compose-graphviz) ⭐ 56 | 🐛 2 | 🌐 Go | 📅 2015-10-01 :skull: - Turn a docker-compose.yml files into Graphviz .dot files by [@abesto](https://github.com/abesto)
...
* [Capitan](https://github.com/byrnedo/capitan) ⭐ 32 | 🐛 3 | 🌐 Go | 📅 2017-06-07 - Composable docker orchestration with added scripting support by [@byrnedo].
...
* [werf](https://github.com/werf/werf) ⭐ 4,638 | 🐛 143 | 🌐 Go | 📅 2026-02-06 - werf is a CI/CD tool for building Docker images efficiently and deploying them to Kubernetes using GitOps by [@flant](https://github.com/flant)
* [gitkube](https://github.com/hasura/gitkube) ⭐ 3,852 | 🐛 44 | 🌐 Go | 📅 2023-08-31 - Gitkube is a tool for building and deploying docker images on Kubernetes using `git push`. By [@Hasura](https://github.com/hasura/).
...
* [Grafeas](https://github.com/grafeas/grafeas) ⭐ 1,563 | 🐛 61 | 🌐 Go | 📅 2026-01-29 - A common API for metadata about containers, from image and build details to security vulnerabilities. By [grafeas](https://github.com/grafeas)
* [awesome-stacks](https://github.com/ethibox/awesome-stacks) ⭐ 1,235 | 🐛 9 | 🌐 Dockerfile | 📅 2026-02-03 - Deploy 150+ open-source web apps with one Docker command
...
* [dockit](https://github.com/humblec/dockit) ⭐ 106 | 🐛 5 | 🌐 Python | 📅 2014-11-04 :skull: - Do docker actions and Deploy gluster containers! By [@humblec](https://github.com/humblec)
...
* [swarm-ansible](https://github.com/LombardiDaniel/swarm-ansible?tab=readme-ov-file) ⭐ 57 | 🐛 0 | 🌐 HCL | 📅 2026-01-24 - Swarm-Ansible bootstraps a production-ready swarm cluster using ansible. Comes with tools to automate CI, help monitoring and traefik pre-configured for SSL certificates and simple-auth. Comes with a private registry and more!
* [docker-to-iac](https://github.com/deploystackio/docker-to-iac) ⭐ 22 | 🐛 9 | 🌐 TypeScript | 📅 2026-02-02 - Translate docker run and commit into Infrastructure as Code templates for AWS, Render.com and DigitalOcean by [@DeployStack](https://github.com/deploystackio)
...
* [Glances](https://github.com/nicolargo/glances) ⭐ 31,563 | 🐛 146 | 🌐 Python | 📅 2026-02-02 - A cross-platform curses-based system monitoring tool written in Python by [@nicolargo](https://github.com/nicolargo)
* [cAdvisor](https://github.com/google/cadvisor) ⭐ 18,854 | 🐛 75 | 🌐 Go | 📅 2026-01-29 - Analyzes resource usage and performance characteristics of running containers. Created by [@Google][google]
* [Checkmate](https://github.com/bluewave-labs/checkmate) ⭐ 9,042 | 🐛 95 | 🌐 TypeScript | 📅 2026-02-07 - Checkmate is an open-source, self-hosted tool designed to track and monitor server hardware, uptime, response times, and incidents in real-time with beautiful visualizations.
* [HertzBeat](https://github.com/dromara/hertzbeat) ⭐ 7,066 | 🐛 309 | 🌐 Java | 📅 2026-02-07 - An open-source real-time monitoring system with custom-monitor and agentless.
* [dockprom](https://github.com/stefanprodan/dockprom) ⭐ 6,480 | 🐛 20 | 📅 2025-07-04 - Docker hosts and containers monitoring with Prometheus, Grafana, cAdvisor, NodeExporter and AlertManager by [@stefanprodan](https://github.com/stefanprodan)
* [Logspout](https://github.com/gliderlabs/logspout) ⭐ 4,698 | 🐛 108 | 🌐 Go | 📅 2023-07-11 - Log routing for Docker container logs by [@gliderlabs][gliderlabs]
* [Autoheal](https://github.com/willfarrell/docker-autoheal) ⭐ 1,777 | 🐛 60 | 🌐 Shell | 📅 2025-09-09 - Monitor and restart unhealthy docker containers automatically.
* [Sidekick](https://github.com/runsidekick/sidekick) ⭐ 1,613 | 🐛 5 | 🌐 Java | 📅 2023-06-29 💲 - Open source live application debugger like Chrome DevTools for your backend. Collect traces and generate logs on-demand without stopping & redeploying your applications.
...
* [Doku](https://github.com/amerkurev/doku) ⭐ 405 | 🐛 7 | 🌐 Python | 📅 2025-12-26 - Doku is a simple web-based application that allows you to monitor Docker disk usage. [@amerkurev](https://github.com/amerkurev)
...
* [DLIA](https://github.com/zorak1103/dlia) ⭐ 2 | 🐛 5 | 🌐 Go | 📅 2026-02-07 - DLIA is an AI-powered Docker log monitoring agent that uses Large Language Models (LLMs) to intelligently analyze container logs, detect anomalies, and provide contextual insights over time. By [@zorak1103](https://github.com/zorak1103)
...
* [netshoot](https://github.com/nicolaka/netshoot) ⭐ 10,354 | 🐛 39 | 🌐 Shell | 📅 2026-01-28 - The netshoot container has a powerful set of networking tools to help troubleshoot Docker networking issues by [@nicolaka](https://github.com/nicolaka)
* [MyIP](https://github.com/jason5ng32/MyIP) ⭐ 9,747 | 🐛 0 | 🌐 Vue | 📅 2026-02-04 - All in one IP Toolbox. Easy to check all your IPs, IP geolocation, check for DNS leaks, examine WebRTC connections, speed test, ping test, MTR test, check website availability, whois search and more. By [@jason5ng32](https://github.com/jason5ng32)
* [Flannel](https://github.com/coreos/flannel/) ⭐ 9,395 | 🐛 19 | 🌐 Go | 📅 2026-02-04 - Flannel is a virtual network that gives a subnet to each host for use with container runtimes. By [@coreos][coreos]
* [Pipework](https://github.com/jpetazzo/pipework) ⭐ 4,254 | 🐛 5 | 🌐 Shell | 📅 2024-11-04 - Software-Defined Networking for Linux Containers, Pipework works with "plain" LXC containers, and with the awesome Docker. By [@jpetazzo][jpetazzo]
...
* [Kubernetes](https://github.com/kubernetes/kubernetes) ⭐ 120,324 | 🐛 2,592 | 🌐 Go | 📅 2026-02-07 - Open source orchestration system for Docker containers by Google
* [Rancher](https://github.com/rancher/rancher) ⭐ 25,329 | 🐛 3,227 | 🌐 Go | 📅 2026-02-06 - An open source project that provides a complete platform for operating Docker in production by [@rancher][rancher].
* [Nomad](https://github.com/hashicorp/nomad) ⭐ 16,165 | 🐛 1,650 | 🌐 Go | 📅 2026-02-06 - Easily deploy applications at any scale. A Distributed, Highly Available, Datacenter-Aware Scheduler by [@hashicorp](https://github.com/hashicorp)
...
* [docker rollout](https://github.com/Wowu/docker-rollout) ⭐ 3,080 | 🐛 11 | 🌐 Shell | 📅 2025-07-25 - Zero downtime deployment for Docker Compose services by [@Wowu](https://github.com/Wowu)
...
* [Panamax](https://github.com/CenturyLinkLabs/panamax-ui) ⭐ 1,438 | 🐛 52 | 🌐 JavaScript | 📅 2022-10-19 :skull: - An open-source project that makes deploying complex containerized apps as easy as Drag-and-Drop by [@CenturyLinkLabs][centurylinklabs].
* [ManageIQ](https://github.com/ManageIQ/manageiq) ⭐ 1,385 | 🐛 331 | 🌐 Ruby | 📅 2026-02-05 - Discover, optimize and control your hybrid IT. By [ManageIQ](https://github.com/ManageIQ)
* [Swarm-cronjob](https://github.com/crazy-max/swarm-cronjob) ⭐ 861 | 🐛 24 | 🌐 Go | 📅 2026-01-13 - Create jobs on a time-based schedule on Swarm by [@crazy-max]
* [Crane](https://github.com/Dataman-Cloud/crane) ⭐ 751 | 🐛 15 | 🌐 Go | 📅 2023-08-31 - Control plane based on docker built-in swarm [@Dataman-Cloud](https://github.com/Dataman-Cloud)
* [Haven](https://github.com/codeabovelab/haven-platform) ⭐ 298 | 🐛 8 | 🌐 Java | 📅 2018-07-06 - Haven is a simplified container management platform that integrates container, application, cluster, image, and registry managements. By [@codeabovelab](https://github.com/codeabovelab)
...
* [CloudSlang](https://github.com/CloudSlang/cloud-slang) ⭐ 241 | 🐛 108 | 🌐 Java | 📅 2026-02-05 - CloudSlang is a workflow engine to create Docker process automation
...
* [RedHerd Framework](https://github.com/redherd-project/redherd-framework) ⭐ 73 | 🐛 0 | 🌐 JavaScript | 📅 2023-04-25 - RedHerd is a collaborative and serverless framework for orchestrating a geographically distributed group of assets capable of simulating complex offensive cyberspace operations. By [@RedHerdProject](https://github.com/redherd-project).
...
* [Ansible Linux Docker](https://github.com/Peco602/ansible-linux-docker) ⭐ 38 | 🐛 0 | 🌐 Shell | 📅 2023-06-21 - Run Ansible from a Linux container. By [@Peco602][peco602]
...
* [Dokku](https://github.com/dokku/dokku) ⭐ 31,864 | 🐛 42 | 🌐 Shell | 📅 2026-02-06 - Docker powered mini-Heroku that helps you build and manage the lifecycle of applications (originally by [@progrium][progrium])
* [caprover](https://github.com/caprover/caprover) ⭐ 14,811 | 🐛 173 | 🌐 TypeScript | 📅 2026-01-31 - \[previously known as CaptainDuckDuck] Automated Scalable Webserver Package (automated Docker+nginx) - Heroku on Steroids
* [Flynn](https://github.com/flynn/flynn) ⚠️ Archived :skull: - A next generation open source platform as a service
* [Tsuru](https://github.com/tsuru/tsuru) ⭐ 5,250 | 🐛 19 | 🌐 Go | 📅 2026-02-05 - Tsuru is an extensible and open source Platform as a Service software
* [Empire](https://github.com/remind101/empire) ⭐ 2,683 | 🐛 89 | 🌐 Go | 📅 2023-11-25 - A PaaS built on top of Amazon EC2 Container Service (ECS)
* [Convox Rack](https://github.com/convox/rack) ⭐ 1,894 | 🐛 24 | 🌐 Go | 📅 2025-12-10 - Convox Rack is open source PaaS built on top of expert infrastructure automation and devops best practices.
...
* [Exoframe](https://github.com/exoframejs/exoframe) ⭐ 1,150 | 🐛 16 | 🌐 JavaScript | 📅 2025-12-18 - A self-hosted tool that allows simple one-command deployments using Docker
...
* [Krane](https://github.com/krane/krane) ⭐ 81 | 🐛 10 | 🌐 Go | 📅 2023-05-11 - Toolset for managing container workloads on remote servers
...
* [Træfɪk](https://github.com/containous/traefik) ⭐ 61,488 | 🐛 741 | 🌐 Go | 📅 2026-02-05 - Automated reverse proxy and load-balancer for Docker, Mesos, Consul, Etcd... By [@EmileVauge](https://github.com/emilevauge)
* [Nginx Proxy Manager](https://github.com/jc21/nginx-proxy-manager) ⭐ 31,537 | 🐛 931 | 🌐 TypeScript | 📅 2026-02-05 - A beautiful web interface for proxying web based services with SSL. By [@jc21](https://github.com/jc21)
* [bunkerized-nginx](https://github.com/bunkerity/bunkerized-nginx) ⭐ 9,916 | 🐛 104 | 🌐 Python | 📅 2026-02-06 - Web app hosting and reverse proxy secure by default. By [@bunkerity](https://github.com/bunkerity)
* [Let's Encrypt Nginx-proxy Companion](https://github.com/nginx-proxy/docker-letsencrypt-nginx-proxy-companion) ⭐ 7,693 | 🐛 49 | 🌐 Shell | 📅 2026-01-28 - A lightweight companion container for the nginx-proxy. It allow the creation/renewal of Let's Encrypt certificates automatically. By [@JrCs](https://github.com/JrCs)
* [fabio](https://github.com/fabiolb/fabio) ⭐ 7,329 | 🐛 244 | 🌐 Go | 📅 2025-12-09 - A fast, modern, zero-conf load balancing HTTP(S) router for deploying microservices managed by consul. By [@magiconair](https://github.com/magiconair) (Frank Schroeder)
* [caddy-docker-proxy](https://github.com/lucaslorentz/caddy-docker-proxy) ⭐ 4,241 | 🐛 85 | 🌐 Go | 📅 2026-02-01 - Caddy-based reverse proxy, configured with service or container labels. By [@lucaslorentz](https://github.com/lucaslorentz)
* [OpenResty Manager](https://github.com/Safe3/openresty-manager) ⭐ 1,303 | 🐛 51 | 🌐 Go | 📅 2026-01-25 - The easiest using, powerful and beautiful OpenResty Manager(Nginx Enhanced Version), open source alternative to OpenResty Edge. By [@Safe3](https://github.com/Safe3/)
...
* [mesh-router](https://github.com/Yundera/mesh-router) ⭐ 5 | 🐛 0 | 🌐 TypeScript | 📅 2026-01-27 - Free domain(nsl.sh) provider for Docker containers with automatic HTTPS routing. Uses Wireguard VPN to securely route subdomain requests across networks. Ideal for self-hosted NAS and cloud deployments. By [@Yundera](https://github.com/Yundera)
* [nginx-proxy][nginxproxy] - Automated nginx proxy for Docker containers using docker-gen by [@jwilder][jwilder]

### Runtime

* [podman](https://github.com/containers/libpod) ⭐ 30,602 | 🐛 1,060 | 🌐 Go | 📅 2026-02-06 - libpod is a library used to create container pods. Home of Podman by [@containers][containers]
* [cri-o](https://github.com/cri-o/cri-o) ⭐ 5,572 | 🐛 82 | 🌐 Go | 📅 2026-02-07 - Open Container Initiative-based implementation of Kubernetes Container Runtime Interface by [cri-o](https://github.com/cri-o)
* [lxc](https://github.com/lxc/lxc) ⭐ 5,104 | 🐛 167 | 🌐 C | 📅 2026-02-01 - LXC - Linux Containers
...
* [runtime-tools](https://github.com/opencontainers/runtime-tools) ⭐ 469 | 🐛 69 | 🌐 Go | 📅 2025-12-05 - oci-runtime-tool is a collection of tools for working with the OCI runtime specification by [@opencontainers](https://github.com/opencontainers)
* [rlxc](https://github.com/brauner/rlxc) ⭐ 18 | 🐛 0 | 🌐 Rust | 📅 2021-06-30 - LXC binary written in Rust by [@brauner](https://github.com/brauner)

### Security

* [Trivy](https://github.com/aquasecurity/trivy) ⭐ 31,574 | 🐛 214 | 🌐 Go | 📅 2026-02-07 - Aqua Security's open source simple and comprehensive vulnerability scanner for containers (suitable for CI).
* [Clair](https://github.com/quay/clair) ⭐ 10,924 | 🐛 57 | 🌐 Go | 📅 2026-02-07 - Clair is an open source project for the static analysis of vulnerabilities in appc and docker containers. By [@coreos][coreos]
* [docker-bench-security](https://github.com/docker/docker-bench-security) ⭐ 9,594 | 🐛 26 | 🌐 Shell | 📅 2024-10-21 - script that checks for dozens of common best-practices around deploying Docker containers in production. By [@docker][docker]
* [Sysdig Falco](https://github.com/falcosecurity/falco) ⭐ 8,635 | 🐛 67 | 🌐 C++ | 📅 2026-02-05 - Sysdig Falco is an open source container security monitor. It can monitor application, container, host, and network activity and alert on unauthorized activity.
* [Checkov](https://github.com/bridgecrewio/checkov) ⭐ 8,454 | 🐛 142 | 🌐 Python | 📅 2026-02-01 - Static analysis for infrastructure as code manifests (Terraform, Kubernetes, Cloudformation, Helm, Dockerfile, Kustomize) find security misconfiguration and fix them. By [@bridgecrew](https://github.com/bridgecrewio)
* [Syft](https://github.com/anchore/syft) ⭐ 8,340 | 🐛 524 | 🌐 Go | 📅 2026-02-06 - CLI tool and library for generating a Software Bill of Materials (SBOM) from container images and filesystems.
* [Deepfence Threat Mapper](https://github.com/deepfence/ThreatMapper) ⭐ 5,230 | 🐛 141 | 🌐 TypeScript | 📅 2026-01-08 - Powerful runtime vulnerability scanner for kubernetes, virtual machines and serverless. By [@deepfence][deepfence]
...
* [oscap-docker](https://github.com/OpenSCAP/openscap) ⭐ 1,661 | 🐛 56 | 🌐 XSLT | 📅 2026-02-02 - OpenSCAP provides oscap-docker tool which is used to scan Docker containers and images. By [OpenSCAP](https://github.com/OpenSCAP)
* [bane](https://github.com/genuinetools/bane) ⭐ 1,227 | 🐛 4 | 🌐 Go | 📅 2020-09-17 - AppArmor profile generator for Docker containers by [@genuinetools][genuinetools]
...
* [docker-explorer](https://github.com/google/docker-explorer) ⭐ 551 | 🐛 11 | 🌐 Python | 📅 2024-10-04 - A tool to help forensicate offline docker acquisitions by [@Google][google]
...
* [CetusGuard](https://github.com/hectorm/cetusguard) ⭐ 82 | 🐛 1 | 🌐 Go | 📅 2026-02-01 - CetusGuard is a tool that protects the Docker daemon socket by filtering calls to its API endpoints
...
* [etcd](https://github.com/etcd-io/etcd) ⭐ 51,466 | 🐛 201 | 🌐 Go | 📅 2026-02-06 - Distributed reliable key-value store for the most critical data of a distributed system by [@etcd-io](https://github.com/etcd-io) (former part of CoreOS)
* [istio](https://github.com/istio/istio) ⭐ 37,908 | 🐛 492 | 🌐 Go | 📅 2026-02-06 - An open platform to connect, manage, and secure microservices by [@istio](https://github.com/istio)
* [registrator](https://github.com/gliderlabs/registrator) ⭐ 4,680 | 🐛 258 | 🌐 Go | 📅 2025-05-22 - Service registry bridge for Docker by [@gliderlabs][gliderlabs] and [@progrium][progrium]
...
* [Minio](https://github.com/minio/minio) ⭐ 60,128 | 🐛 79 | 🌐 Go | 📅 2026-01-06 - S3 compatible object storage server in Docker containers
* [Docker Volume Backup](https://github.com/offen/docker-volume-backup) ⭐ 3,365 | 🐛 24 | 🌐 Go | 📅 2026-02-03 Backup Docker volumes locally or to any S3 compatible storage. By [@offen](https://github.com/offen)
* [REX-Ray](https://github.com/rexray/rexray) ⭐ 2,223 | 🐛 294 | 🌐 Go | 📅 2023-09-02 provides a vendor agnostic storage orchestration engine. The primary design goal is to provide persistent storage for Docker, Kubernetes, and Mesos. By[@thecodeteam](https://github.com/thecodeteam) (DELL Technologies)
...
* [Netshare](https://github.com/ContainX/docker-volume-netshare) ⭐ 1,144 | 🐛 99 | 🌐 Go | 📅 2021-04-12 Docker NFS, AWS EFS, Ceph & Samba/CIFS Volume Plugin. By [@ContainX][containx]
...
* [docker.el](https://github.com/Silex/docker.el) ⭐ 806 | 🐛 6 | 🌐 Emacs Lisp | 📅 2026-01-26 Manage docker from Emacs by [@Silex](https://github.com/Silex)
...
* [Stevedore](https://github.com/slonopotamus/stevedore) ⭐ 371 | 🐛 2 | 🌐 Rust | 📅 2026-02-05 - Good Docker Desktop replacement for Windows. Both Linux and Windows Containers are supported. [@slonopotamus](https://github.com/slonopotamus)
...
* [dive](https://github.com/wagoodman/dive) ⭐ 53,283 | 🐛 193 | 🌐 Go | 📅 2025-12-15 - A tool for exploring each layer in a docker image. By [wagoodman](https://github.com/wagoodman).
* [lazydocker](https://github.com/jesseduffield/lazydocker) ⭐ 49,550 | 🐛 258 | 🌐 Go | 📅 2026-01-17 - The lazier way to manage everything docker. A simple terminal UI for both docker and docker-compose, written in Go with the gocui library. By [@jesseduffield](https://github.com/jesseduffield)
* [ctop (2)](https://github.com/bcicen/ctop) ⭐ 17,571 | 🐛 118 | 🌐 Go | 📅 2024-07-08 - :skull: Top-like interface for container metrics (Golang) by [@bcicen](https://github.com/bcicen/)
* [dockly](https://github.com/lirantal/dockly) ⭐ 4,005 | 🐛 3 | 🌐 JavaScript | 📅 2026-02-01 - An interactive shell UI for managing Docker containers by [@lirantal](https://github.com/lirantal)
* [dry](https://github.com/moncho/dry) ⭐ 3,215 | 🐛 39 | 🌐 Go | 📅 2026-01-01 - An interactive CLI for Docker containers by [@moncho](https://github.com/moncho)
* [DockSTARTer](https://github.com/GhostWriters/DockSTARTer) ⭐ 2,541 | 🐛 9 | 🌐 Shell | 📅 2026-02-04 - DockSTARTer helps you get started with home server apps running in Docker by [GhostWriters](https://github.com/GhostWriters)
...
* [oxker](https://github.com/mrjackwills/oxker) ⭐ 1,482 | 🐛 22 | 🌐 Rust | 📅 2026-02-06 - A simple tui to view & control docker containers. Written in [Rust](https://rust-lang.org/), making heavy use of [ratatui](https://github.com/tui-rs-revival/ratatui) ⭐ 18,192 | 🐛 198 | 🌐 Rust | 📅 2026-02-05 & [Bollard](https://github.com/fussybeaver/bollard) ⭐ 1,202 | 🐛 44 | 🌐 Rust | 📅 2026-02-01, by [@mrjackwills](https://github.com/mrjackwills)
* [lazyjournal](https://github.com/Lifailon/lazyjournal) ⭐ 1,094 | 🐛 0 | 🌐 Go | 📅 2026-02-06 - A interface for reading and filtering the logs output of Docker and Podman containers like [Dozzle](origin/dozzle) but for the terminal with support for fuzzy find, regex and output coloring
* [sen](https://github.com/TomasTomecek/sen) ⭐ 1,042 | 🐛 33 | 🌐 Python | 📅 2025-08-12 - :skull: Terminal user interface for docker engine, by [@TomasTomecek][tomastomecek]
...
* [DockMate](https://github.com/shubh-io/dockmate) ⭐ 270 | 🐛 1 | 🌐 Go | 📅 2026-01-14 - Lightweight terminal-based Docker and Podman manager with a text-based user interface, by [@shubh-io](https://github.com/shubh-io).
* [dockdash](https://github.com/byrnedo/dockdash) ⭐ 124 | 🐛 0 | 🌐 Go | 📅 2022-06-01 detailed stats. By [@byrnedo]
* [d4s](https://github.com/jr-k/d4s) ⭐ 38 | 🐛 0 | 🌐 Go | 📅 2026-02-06 - A fast, keyboard-driven terminal UI to manage Docker containers, Compose stacks, and Swarm services with the ergonomics of K9s by [@jr-k](https://github.com/jr-k/)
* [dprs](https://github.com/durableprogramming/dprs) ⭐ 33 | 🐛 0 | 🌐 Rust | 📅 2026-01-20 - A developer-focused TUI for managing Docker containers with real-time log streaming and container management. Built with Rust. By [@durableprogramming](https://github.com/durableprogramming)

##### CLI tools

* [skopeo](https://github.com/containers/skopeo) ⭐ 10,411 | 🐛 73 | 🌐 Go | 📅 2026-02-03 - Work with remote images registries - retrieving information, images, signing content by [@containers][containers]
...
* [wharfee](https://github.com/j-bennet/wharfee) ⭐ 658 | 🐛 26 | 🌐 Python | 📅 2024-06-12 - :skull: Autocompletion and syntax highlighting for Docker commands. by [@j-bennet](https://github.com/j-bennet)
* [DVM](https://github.com/howtowhale/dvm) ⭐ 525 | 🐛 16 | 🌐 Go | 📅 2022-03-30 - Docker version manager by [@howtowhale](https://github.com/howtowhale)
...
* [captain](https://github.com/jenssegers/captain) ⭐ 245 | 🐛 7 | 🌐 Go | 📅 2022-12-08 - Easily start and stop docker compose projects from any directory. By [@jenssegers](https://github.com/jenssegers)
...
* [dcp](https://github.com/exdx/dcp) ⭐ 113 | 🐛 15 | 🌐 Rust | 📅 2023-07-24 - A simple tool for copying files from container filesystems. By [@exdx](https://github.com/exdx)
* [proco](https://github.com/shiwaforce/poco) ⭐ 109 | 🐛 22 | 🌐 Python | 📅 2025-09-23 - Proco will help you to organise and manage Docker, Docker-Compose, Kubernetes projects of any complexity using simple YAML config files to shorten the route from finding your project to initialising it in your local environment. by [@shiwaforce](https://github.com/shiwaforce)
...
* [tsaotun](https://github.com/qazbnm456/tsaotun) ⭐ 56 | 🐛 1 | 🌐 Python | 📅 2022-10-04 - Python based Assistance for Docker by [@qazbnm456](https://github.com/qazbnm456)
...
* [docker-captain](https://github.com/lucabello/docker-captain) ⭐ 2 | 🐛 2 | 🌐 Python | 📅 2026-02-07 - A friendly CLI to manage multiple Docker Compose deployments with style — powered by Typer, Rich, questionary, and sh.

##### Other

* [dockercraft](https://github.com/docker/dockercraft) ⚠️ Archived - :skull: Docker + Minecraft = Dockercraft by [@docker][docker]
* [docker-ssh](https://github.com/jeroenpeeters/docker-ssh) ⭐ 661 | 🐛 30 | 🌐 JavaScript | 📅 2018-04-11 - SSH Server for Docker containers \~ Because every container should be accessible. By [@jeroenpeeters](https://github.com/jeroenpeeters)
...
* [netdata](https://github.com/netdata/netdata) ⭐ 77,666 | 🐛 257 | 🌐 C | 📅 2026-02-07 - Real-time performance monitoring
* [Portainer](https://github.com/portainer/portainer) ⭐ 36,476 | 🐛 710 | 🌐 TypeScript | 📅 2026-02-06 - A lightweight management UI for managing your Docker hosts or Docker Swarm clusters by [@portainer](https://github.com/portainer)
* [dockge](https://github.com/louislam/dockge) ⭐ 21,870 | 🐛 131 | 🌐 TypeScript | 📅 2026-01-21 - easy-to-use and reactive self-hosted docker compose.yaml stack-oriented manager by [@louislam](https://github.com/louislam).
* [Theia](https://github.com/eclipse-theia/theia) ⭐ 21,343 | 🐛 1,718 | 🌐 TypeScript | 📅 2026-02-06 - Extensible platform to develop full-fledged multi-language Cloud & Desktop IDE-like products with state-of-the-art web technologies.
* [Komodo](https://github.com/mbecker20/komodo) ⭐ 10,094 | 🐛 404 | 🌐 Rust | 📅 2026-02-07 - A tool to build and deploy software on many servers
* [OctoLinker](https://github.com/OctoLinker/OctoLinker) ⭐ 5,351 | 🐛 62 | 🌐 HTML | 📅 2023-10-02 - A browser extension for GitHub that makes the image name in a `Dockerfile` clickable and redirect you to the related Docker Hub page.
* [Swarmpit](https://github.com/swarmpit/swarmpit) ⭐ 3,402 | 🐛 193 | 🌐 Clojure | 📅 2026-01-25 - Swarmpit provides simple and easy to use interface for your Docker Swarm cluster. You can manage your stacks, services, secrets, volumes, networks etc.
...
* [Docker Registry UI (Joxit)](https://github.com/Joxit/docker-registry-ui) ⭐ 3,322 | 🐛 34 | 🌐 Riot | 📅 2026-01-19 - :skull: The simplest and cleanest UI for private registries by [@Joxit](https://github.com/Joxit)
...
* [Kubevious](https://github.com/kubevious/kubevious) ⭐ 1,692 | 🐛 17 | 📅 2024-01-15 - A highly visual web UI for Kubernetes which renders configuration and state in an application centric way by [@rubenhak](https://github.com/rubenhak).
...
* [dockemon](https://github.com/ProductiveOps/dokemon) ⭐ 753 | 🐛 18 | 🌐 TypeScript | 📅 2024-02-21 - Docker Container Management GUI by [@productiveops](https://github.com/ProductiveOps)
* [Docker Registry Browser](https://github.com/klausmeyer/docker-registry-browser) ⭐ 667 | 🐛 9 | 🌐 Ruby | 📅 2026-02-03 - Web Interface for the Docker Registry HTTP API v2 by [@klausmeyer](https://github.com/klausmeyer)
...
* [Mafl](https://github.com/hywax/mafl) ⭐ 665 | 🐛 43 | 🌐 TypeScript | 📅 2025-10-26 - Minimalistic flexible homepage by [@hywax](https://github.com/hywax/)
...
* [Container Web TTY](https://github.com/wrfly/container-web-tty) ⭐ 259 | 🐛 6 | 🌐 Go | 📅 2026-02-07 - Connect your containers via a web-tty [@wrfly](https://github.com/wrfly)
...
* [Rapid Dashboard](https://github.com/ozlerhakan/rapid) ⭐ 148 | 🐛 1 | 🌐 Java | 📅 2021-09-21 - A simple query dashboard to use Docker Remote API by [@ozlerhakan](https://github.com/ozlerhakan/)
* [CASA](https://github.com/knrdl/casa) ⭐ 84 | 🐛 0 | 🌐 Svelte | 📅 2026-02-04 - Outsource the administration of a handful of containers to your co-workers, by [@knrdl](https://github.com/knrdl)
* [Yacht](https://github.com/SelfhostedPro/Yacht) ⭐ 46 | 🐛 17 | 📅 2026-02-02 :construction: - A Web UI for docker that focuses on templates and ease of use in order to make deployments as easy as possible. By [@SelfhostedPro](https://github.com/SelfhostedPro)
...
* [distroless](https://github.com/GoogleContainerTools/distroless) ⭐ 22,173 | 🐛 19 | 🌐 Starlark | 📅 2026-02-05 - Language focused docker images, minus the operating system, by [@GoogleContainerTools][googlecontainertools]
...
* [docker-alpine](https://github.com/gliderlabs/docker-alpine) ⭐ 5,717 | 🐛 123 | 🌐 Shell | 📅 2021-04-01 - A super small Docker base image *(5MB)* using Alpine Linux by [@gliderlabs][gliderlabs]
* [GoSu](https://github.com/tianon/gosu) ⭐ 4,938 | 🐛 5 | 🌐 Shell | 📅 2026-01-19 - Run this specific application as this specific user and get out of the pipeline (entrypoint script tool) by [@tianon](https://github.com/tianon)
* [docker-gen](https://github.com/jwilder/docker-gen) ⭐ 4,614 | 🐛 54 | 🌐 Go | 📅 2026-02-04 - Generate files from docker container meta-data by [@jwilder][jwilder]
* [Ofelia](https://github.com/mcuadros/ofelia/) ⭐ 3,693 | 🐛 144 | 🌐 Go | 📅 2026-02-04 - Ofelia is a modern and low footprint job scheduler for docker environments, built on Go. Ofelia aims to be a replacement for the old fashioned cron. Supports configuration from container labels and/or configuration files.
* [supercronic](https://github.com/aptible/supercronic) ⭐ 2,363 | 🐛 40 | 🌐 Go | 📅 2026-01-30 - crontab-compatible job runner, designed specifically to run in containers by [@aptible](https://github.com/aptible/)
* [amicontained](https://github.com/genuinetools/amicontained) ⭐ 1,068 | 🐛 7 | 🌐 Go | 📅 2020-12-09 - Container introspection tool. Find out what container runtime is being used as well as features available by [@genuinetools][genuinetools]
* [su-exec](https://github.com/ncopa/su-exec) ⭐ 1,016 | 🐛 17 | 🌐 C | 📅 2025-10-07 - This is a simple tool that will simply execute a program with different privileges. The program will be executed directly and not run as a child, like su and sudo does, which avoids TTY and signal issues. Why reinvent gosu? This does more or less exactly the same thing as gosu but it is only 10kb instead of 1.8MB. By [ncopa](https://github.com/ncopa)
...
* [microcheck](https://github.com/tarampampam/microcheck) ⭐ 121 | 🐛 0 | 🌐 C | 📅 2025-12-04 - Lightweight health check utilities for Docker containers (75 KB instead of 9.3 MB for httpcheck versus cURL) in pure C - http(s), port checks, and parallel execution are included. by [@tarampampam](https://github.com/tarampampam)
* [ckron](https://github.com/nicomt/ckron) ⭐ 56 | 🐛 20 | 🌐 JavaScript | 📅 2025-12-07 - A cron-style job scheduler for docker, by [@nicomt](https://github.com/nicomt)
...
* [SparkView](https://github.com/beyondssl/sparkview-container) ⭐ 19 | 🐛 1 | 🌐 HTML | 📅 2025-09-22 - Access VMs, desktops, servers or applications anytime and from anywhere, without complex and costly client roll-outs or user management.
...
* [DockerSlim](https://github.com/docker-slim/docker-slim) ⭐ 22,805 | 🐛 203 | 🌐 Go | 📅 2026-01-23 shrinks fat Docker images creating the smallest possible images.
...
* [BuildKit](https://github.com/moby/buildkit) ⭐ 9,744 | 🐛 928 | 🌐 Go | 📅 2026-02-05 - Concurrent, cache-efficient, and Dockerfile-agnostic builder toolkit by [@moby project](https://github.com/moby)
* [buildah](https://github.com/containers/buildah) ⭐ 8,588 | 🐛 256 | 🌐 Go | 📅 2026-02-06 - A tool that facilitates building OCI images by [@containers][containers]
* [img](https://github.com/genuinetools/img) ⭐ 3,986 | 🐛 110 | 🌐 Go | 📅 2024-05-19 - Standalone, daemon-less, unprivileged Dockerfile and OCI compatible container image builder by [@genuinetools][genuinetools]
...
* [runlike](https://github.com/lavie/runlike) ⭐ 2,907 | 🐛 7 | 🌐 Python | 📅 2025-12-04 - Generate `docker run`command and options from running containers by [@lavie](https://github.com/lavie)
...
* [Whaler](https://github.com/P3GLEG/Whaler) ⭐ 1,183 | 🐛 5 | 🌐 Go | 📅 2025-09-17 - Program to reverse Docker images into Dockerfiles by [@P3GLEG](https://github.com/P3GLEG/).
...
* [RAUDI](https://github.com/cybersecsi/RAUDI) ⭐ 560 | 🐛 5 | 🌐 Python | 📅 2026-02-04 - A tool to automatically update (and optionally push to Docker Hub) Docker Images for 3rd party software whenever theres is a new release/update/commit. By [@SecSI](https://github.com/cybersecsi)
* [HPC Container Maker](https://github.com/NVIDIA/hpc-container-maker) ⭐ 505 | 🐛 18 | 🌐 Python | 📅 2026-01-09 - Generates Dockerfiles from a high level Python recipe, including building blocks for High-Performance Computing components by [@NVIDIA][nvidia]
* [dlayer](https://github.com/orisano/dlayer) ⭐ 444 | 🐛 6 | 🌐 Go | 📅 2026-02-02 - docker layer analyzer by [@orisano](https://github.com/orisano)
* [Whales](https://github.com/Gueils/whales) ⭐ 390 | 🐛 4 | 🌐 Ruby | 📅 2019-05-27 - A tool to automatically dockerize your applications by [@icalialabs](https://github.com/IcaliaLabs).
* [dockramp](https://github.com/jlhawn/dockramp) ⭐ 259 | 🐛 6 | 🌐 Go | 📅 2016-05-02 :skull: - Proof of Concept: A Client Driven Docker Image Builder by [@jlhawn](https://github.com/jlhawn)
...
* [docker-replay](https://github.com/bcicen/docker-replay) ⭐ 202 | 🐛 0 | 🌐 Python | 📅 2018-10-13 - Generate `docker run`command and options from running containers. By [bcicen](https://github.com/bcicen)
...
* [cekit](https://github.com/cekit/cekit) ⭐ 113 | 🐛 27 | 🌐 Python | 📅 2026-01-30 - A tool used by openshift to build base images using different build engines by [@cekit](https://github.com/cekit).
...
* [dockerfilegraph](https://github.com/patrickhoefler/dockerfilegraph) ⭐ 251 | 🐛 2 | 🌐 Go | 📅 2026-02-07 - Visualize your multi-stage Dockerfiles. By [@PatrickHoefler](https://github.com/patrickhoefler)
...
* [@jessfraz](https://github.com/jessfraz/dockerfiles) ⭐ 13,955 | 🐛 79 | 🌐 Dockerfile | 📅 2024-07-06
* [@vimagick](https://github.com/vimagick/dockerfiles) ⭐ 3,206 | 🐛 82 | 🌐 Dockerfile | 📅 2026-02-04
...
* [Hadolint](https://github.com/hadolint/hadolint) ⭐ 11,917 | 🐛 249 | 🌐 Haskell | 📅 2026-01-27 - A Dockerfile linter that checks for best practices, common mistakes, and is also able to lint any bash written in `RUN` instructions; by [@lukasmartinelli](https://github.com/lukasmartinelli)
* [FROM:latest](https://github.com/replicatedhq/dockerfilelint) ⭐ 1,031 | 🐛 55 | 🌐 JavaScript | 📅 2023-09-27 - An opinionated Dockerfile linter by [@replicatedhq](https://github.com/replicatedhq)
...
* [Dockadvisor](https://github.com/deckrun/dockadvisor) ⭐ 168 | 🐛 0 | 🌐 Go | 📅 2026-01-12 - Lightweight Dockerfile linter with 60+ rules, quality scoring, and security checks by [@deckrun](https://github.com/deckrun)
* [docker-image-size-limit](https://github.com/wemake-services/docker-image-size-limit) ⭐ 129 | 🐛 1 | 🌐 Python | 📅 2026-02-04 - A tool to keep an eye on your docker images size.
...
* [opencontainer](https://github.com/opencontainers/image-spec/blob/master/annotations.md) ⭐ 4,133 | 🐛 73 | 🌐 Go | 📅 2026-02-06 - A convention and shared namespace for Docker labels defined by OCI Image Spec.

### Registry

Services to securely store your Docker images.

* [Harbor](https://github.com/goharbor/harbor) ⭐ 27,529 | 🐛 762 | 🌐 Go | 📅 2026-02-07 An open source trusted cloud native registry project that stores, signs, and scans content. Supports replication, user management, access control and activity auditing. By [CNCF](https://www.cncf.io) formerly [VMWare][vmware]
* [Kraken](https://github.com/uber/kraken) ⭐ 6,635 | 🐛 120 | 🌐 Go | 📅 2026-02-04 - Uber's Highly scalable P2P docker registry, capable of distributing TBs of data in seconds.
* [Dragonfly](https://github.com/dragonflyoss/Dragonfly2) ⭐ 3,022 | 🐛 32 | 🌐 Go | 📅 2026-02-06 - Provide efficient, stable and secure file distribution and image acceleration based on p2p technology.
...
* [dockerode](https://github.com/apocas/dockerode) ⭐ 4,813 | 🐛 26 | 🌐 JavaScript | 📅 2026-01-09 - Docker Remote API node.js module by [@apocas](https://github.com/apocas)
...
* [go-dockerclient](https://github.com/fsouza/go-dockerclient/) ⭐ 2,234 | 🐛 13 | 🌐 Go | 📅 2026-01-31 - Go HTTP client for the Docker remote API by [@fsouza](https://github.com/fsouza/)
* [docker-maven-plugin](https://github.com/fabric8io/docker-maven-plugin) ⭐ 1,930 | 🐛 511 | 🌐 Java | 📅 2026-01-29 - A Maven plugin for running and creating Docker images by [@fabric8io](https://github.com/fabric8io)
...
* [docker-java-api](https://github.com/amihaiemil/docker-java-api) ⭐ 275 | 🐛 25 | 🌐 Java | 📅 2021-06-04 - Lightweight, truly object-oriented, Java client for Docker's API. By [@amihaiemil](https://github.com/amihaiemil)
* [docker-controller-bot](https://github.com/dgongut/docker-controller-bot) ⭐ 237 | 🐛 10 | 🌐 Python | 📅 2026-02-04 - Telegram bot to control docker containers. By [@dgongut](https://github.com/dgongut/)
...
* [contajners](https://github.com/lispyclouds/contajners) ⭐ 144 | 🐛 0 | 🌐 Clojure | 📅 2026-01-30 - An idiomatic, data-driven, REPL friendly Clojure client for OCI container engines. By [@lispyclouds][lispyclouds]
...
* [Docker Client for JVM](https://github.com/gesellix/docker-client) ⭐ 118 | 🐛 28 | 🌐 Groovy | 📅 2026-02-06 - A Docker remote api client library for the JVM, written in Groovy by [@gesellix][gesellix]
* [Gradle Docker plugin](https://github.com/gesellix/gradle-docker-plugin) ⭐ 81 | 🐛 15 | 🌐 Groovy | 📅 2026-02-02 - A Docker remote api plugin for Gradle by [@gesellix][gesellix]
...
* [Docker.Registry.DotNet](https://github.com/ChangemakerStudios/Docker.Registry.DotNet) ⭐ 41 | 🐛 6 | 🌐 C# | 📅 2025-10-06 - .NET (C#) Client Library for interacting with a Docker Registry API (v2) [@rquackenbush](https://github.com/rquackenbush)
...
* [Drone](https://github.com/drone/drone) ⭐ 33,857 | 🐛 83 | 🌐 Go | 📅 2026-02-06 - Continuous integration server built on Docker and configured using YAML files.
* [Watchtower](https://github.com/containrrr/watchtower) ⚠️ Archived - Automatically update running Docker containers
* [Diun](https://github.com/crazy-max/diun) ⭐ 4,371 | 🐛 91 | 🌐 Go | 📅 2026-02-06 - Receive notifications when an image or repository is updated on a Docker registry by [@crazy-max].
* [dockcheck](https://github.com/mag37/dockcheck) ⭐ 2,190 | 🐛 10 | 🌐 Shell | 📅 2026-02-06 - A script checking updates for docker images without pulling then auto-update selected/all containers. With notifications, pruning and more.
* [Ouroboros](https://github.com/pyouroboros/ouroboros) ⭐ 1,612 | 🐛 46 | 🌐 Python | 📅 2023-02-09 :skull: - Automatically update running Docker containers with notifications
...
* [Captain](https://github.com/harbur/captain) ⭐ 775 | 🐛 22 | 🌐 Go | 📅 2025-05-25 - Convert your Git workflow to Docker containers ready for Continuous Delivery by [@harbur](https://github.com/harbur).
...
* [Defang](https://github.com/DefangLabs/defang) ⭐ 145 | 🐛 197 | 🌐 Go | 📅 2026-02-07 - Deploy Docker Compose to your favorite cloud in minutes by [@DefangLabs](https://github.com/DefangLabs)
...
* [Gantry](https://github.com/shizunge/gantry) ⭐ 84 | 🐛 1 | 🌐 Shell | 📅 2026-02-04 - Automatically update selected Docker swarm services.
...
* [coder](https://github.com/coder/coder) ⭐ 12,167 | 🐛 838 | 🌐 Go | 📅 2026-02-07 - remote development machines powered by Terraform or Docker by [@coder](https://github.com/coder)
* [Boot2Docker](https://github.com/boot2docker/boot2docker) ⚠️ Archived :skull: - Docker for OSX and Windows
* [Eclipse Che](https://github.com/eclipse/che) ⭐ 7,124 | 🐛 273 | 🌐 TypeScript | 📅 2026-02-04 - Developer workspace server with Docker runtimes, cloud IDE, next-generation Eclipse IDE
* [Lando](https://github.com/lando/lando) ⭐ 4,226 | 🐛 173 | 📅 2025-12-17 - Lando is for developers who want to quickly specify and painlessly spin up the services and tools needed to develop their projects. By [Tandem](https://www.thinktandem.io/)
...
* [Vagga](https://github.com/tailhook/vagga) ⭐ 1,893 | 🐛 78 | 🌐 Rust | 📅 2023-03-31 - Vagga is a containerisation tool without daemons. It is a fully-userspace container engine inspired by Vagrant and Docker, specialized for development environments by [@tailhook](https://github.com/tailhook/)
...
* [DIP](https://github.com/bibendi/dip) ⭐ 1,318 | 🐛 15 | 🌐 Ruby | 📅 2024-12-25 - CLI utility for straightforward provisioning and interacting with an application configured by docker-compose. By [@bibendi](https://github.com/bibendi)
* [Zsh-in-Docker](https://github.com/deluan/zsh-in-docker) ⭐ 1,089 | 🐛 9 | 🌐 Shell | 📅 2024-09-30 - Install Zsh, Oh-My-Zsh and plugins inside a Docker container with one line! By [Deluan](https://www.deluan.com)
...
* [Gebug](https://github.com/moshebe/gebug) ⭐ 634 | 🐛 11 | 🌐 Go | 📅 2026-02-06 - A tool that makes debugging of Dockerized Go applications super easy by enabling Debugger and Hot-Reload features, seamlessly.
...
* [DockerDL](https://github.com/matifali/dockerdl) ⭐ 87 | 🐛 0 | 🌐 Dockerfile | 📅 2025-12-29 - Deep Learning Docker Images. Don't waste time setting up a deep learning env when you can get a deep learning environment with everything pre-installed.
...
* [ESP32 Linux - Docker builder](https://github.com/hpsaturn/esp32s3-linux) ⭐ 76 | 🐛 0 | 🌐 Dockerfile | 📅 2025-04-05 - Container solution to compile Linux and develop it for ESP32 microcontrollers - By [@Hpsaturn](https://github.com/hpsaturn)
* [dde](https://github.com/whatwedo/dde) ⭐ 46 | 🐛 15 | 🌐 Shell | 📅 2025-11-25 :construction: - Local development environment toolset based on Docker. By [@whatwedo](https://github.com/whatwedo)
...
* [uniget](https://github.com/uniget-org/cli) ⭐ 20 | 🐛 18 | 🌐 Go | 📅 2025-12-18 - uni(versal)get, the installer and updater for container tools and beyond (formerly docker-setup). By [@nicholasdille](https://github.com/nicholasdille)
...
* [Docuum](https://github.com/stepchowfun/docuum) ⭐ 681 | 🐛 13 | 🌐 Rust | 📅 2025-12-12 - Least recently used (LRU) eviction of Docker images by [@stepchowfun](https://github.com/stepchowfun)
...
* [OpenFaaS](https://github.com/openfaas/faas) ⭐ 26,072 | 🐛 31 | 🌐 Go | 📅 2025-11-01 - A complete serverless functions framework for Docker and Kubernetes. By [OpenFaaS](https://github.com/openfaas)
* [Apache OpenWhisk](https://github.com/apache/openwhisk) ⭐ 6,753 | 🐛 432 | 🌐 Scala | 📅 2026-01-24 - a serverless, open source cloud platform that executes functions in response to events at any scale. By [@apache](https://github.com/apache)
...
* [dgoss](https://github.com/aelsabbahy/goss/tree/master/extras/dgoss) ⭐ 5,863 | 🐛 92 | 🌐 Go | 📅 2025-05-01 - A fast YAML based tool for validating docker containers.
* [Pumba](https://github.com/alexei-led/pumba) ⭐ 2,972 | 🐛 36 | 🌐 Go | 📅 2025-12-06 - Chaos testing tool for Docker. Can be deployed on kubernetes and CoreOS cluster. By [@alexei-led](https://github.com/alexei-led)
* [Container Structure Test](https://github.com/GoogleContainerTools/container-structure-test) ⭐ 2,452 | 🐛 106 | 🌐 Go | 📅 2026-01-19 - A framework to validate the structure of an image by checking the outputs of commands or the contents of the filesystem. By [@GoogleContainerTools][googlecontainertools]
* [Kurtosis](https://github.com/kurtosis-tech/kurtosis) ⭐ 521 | 🐛 349 | 🌐 Go | 📅 2026-02-07 - A composable build system for multi-container test environments that provides developers with: a powerful Python-like SDK for environment configuration, a compile-time validator to verify environment behavior & setup, and a runtime for environment execution, monitoring, & debugging capabilities. By [Kurtosis](https://www.kurtosis.com/)
* [DockerSpec](https://github.com/zuazo/dockerspec) ⭐ 180 | 🐛 10 | 🌐 Ruby | 📅 2017-08-30 - A small Ruby Gem to run RSpec and Serverspec, Infrataster and Capybara tests against Dockerfiles or Docker images easily. By [@zuazo](https://github.com/zuazo)
...
* [Preevy](https://github.com/livecycle/preevy) ⭐ 2,185 | 🐛 51 | 🌐 TypeScript | 📅 2026-02-06 - Preview environments for Docker and Docker Compose projects. Test your changes and get feedback from devs and non-devs (Product/Design) by deploying pull requests to the your cloud provider as part of your CI pipeline.
...
* [udocker](https://github.com/indigo-dc/udocker) ⭐ 1,691 | 🐛 37 | 🌐 Python | 📅 2025-08-13 - A tool to execute simple docker containers in batch or interactive systems without root privileges by [@inidigo-dc](https://github.com/indigo-dc)
...
* [Terraform cloud-init config](https://github.com/christippett/terraform-cloudinit-container-server) ⭐ 119 | 🐛 4 | 🌐 HCL | 📅 2022-08-19 - Terraform module for deploying a single Docker image or `docker-compose.yaml` file to any Cloud™ VM
...
* [DockStat](https://github.com/its4nik/dockstat) ⭐ 4 | 🐛 13 | 🌐 TypeScript | 📅 2026-02-05 :construction: - A full fletched (WIP) Docker management solution featuring plugin support and community integration by [its4nik](https://github.com/its4nik)
...
* [Cloud Native Landscape](https://github.com/cncf/landscape) ⭐ 9,811 | 🐛 39 | 📅 2026-02-06
...
* [Awesome Selfhosted](https://github.com/awesome-selfhosted/awesome-selfhosted) ⭐ 272,015 | 🐛 0 | 📅 2026-02-04 list of Free Software network services and web applications which can be hosted locally by running in a classical way (setup local web server and run applications from there) or in a Docker container. By [@Kickball](https://github.com/Kickball)
* [Awesome Compose](https://github.com/docker/awesome-compose) ⭐ 43,795 | 🐛 330 | 🌐 HTML | 📅 2026-02-05 - Docker Compose samples
* [Awesome Sysadmin](https://github.com/n1trux/awesome-sysadmin) ⭐ 32,700 | 🐛 58 | 📅 2026-02-01 by [@n1trux](https://github.com/n1trux)
* [ToolsOfTheTrade](https://github.com/cjbarber/ToolsOfTheTrade) ⭐ 16,939 | 🐛 28 | 📅 2024-08-03 a list of SaaS and On premise applications by [@cjbarber](https://github.com/cjbarber)
* [Awesome Kubernetes](https://github.com/ramitsurana/awesome-kubernetes) ⭐ 15,798 | 🐛 73 | 🌐 Shell | 📅 2025-08-28 by [@ramitsurana][ramitsurana]
* [Awesome Linux Container](https://github.com/Friz-zy/awesome-linux-containers) ⭐ 2,022 | 🐛 7 | 📅 2024-04-09 more general about container than this repo, by [@Friz-zy](https://github.com/Friz-zy).
...
* [Dockerfile best practices](https://github.com/hexops/dockerfile) ⭐ 4,092 | 🐛 3 | 🌐 Dockerfile | 📅 2021-08-08 - This repository has best-practices for writing Dockerfiles
...
* [How CVE's are handled on Offical Docker Images](https://github.com/docker-library/official-images/issues/1448) ⭐ 6,908 | 🐛 44 | 🌐 Shell | 📅 2026-02-05
